...
export const Tailwind: {
    ...
    TabButton: (input: tabs.TabButtonProps) => JSX_2.Element;
    TabContent: (input: {
        count?: number;
        label: string;
    }) => JSX_2.Element;
    TabLink: (input: tabs.TabLinkProps) => JSX_2.Element;
    TabPanel: (input: {
        children: ReactNode;
        name: string;
    }) => JSX_2.Element;
    TabProvider: (input: tabs.TabProviderProps) => JSX_2.Element;
    useTabContext: () => tabs.TabsState;
    FormField: (input: form.FormFieldProps) => JSX_2.Element;
    FormFieldWrap: (input: {
        children: ReactNode;
    }) => JSX_2.Element;
    Input: (input: form.InputProps) => JSX_2.Element;
    InputDemo: () => JSX_2.Element;
    Select: (input: form.SelectProps) => JSX_2.Element;
    ...
    Icon: (input: icon.IconProps) => JSX_2.Element;
...
//
// vortex-api-v1.16.4/extensions/mod_management/selectors.d.ts:59:5 - (ae-forgotten-export) The symbol "INeedToDeployMap" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/tailwind/index.d.ts:71:5 - (ae-forgotten-export) The symbol "tabs" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/tailwind/index.d.ts:88:5 - (ae-forgotten-export) The symbol "form" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/tailwind/index.d.ts:96:5 - (ae-forgotten-export) The symbol "collectiontile" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/tailwind/index.d.ts:99:5 - (ae-forgotten-export) The symbol "ICollectionTileDemoProps" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/tailwind/index.d.ts:100:5 - (ae-forgotten-export) The symbol "link" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/tailwind/index.d.ts:101:5 - (ae-forgotten-export) The symbol "icon" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/tailwind/index.d.ts:109:9 - (ae-forgotten-export) The symbol "button" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/tailwind/index.d.ts:169:5 - (ae-forgotten-export) The symbol "typography" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/types/IDialog.d.ts:82:9 - (ae-forgotten-export) The symbol "IBBCodeContext" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/types/IState.d.ts:361:9 - (ae-forgotten-export) The symbol "IHistoryState" needs to be exported by the entry point index.d.ts
// vortex-api-v1.16.4/types/IState.d.ts:391:9 - (ae-forgotten-export) The symbol "IHistoryPersistent" needs to be exported by the entry point index.d.ts
