...
> [Globals](../globals.md) / SortIndicator
...
* [constructor](sortindicator.md#constructor)

### Properties

* [context](sortindicator.md#context)
* [props](sortindicator.md#props)
* [refs](sortindicator.md#refs)
* [state](sortindicator.md#state)
* [contextType](sortindicator.md#contexttype)

### Methods

* [UNSAFE\_componentWillMount](sortindicator.md#unsafe_componentwillmount)
* [UNSAFE\_componentWillReceiveProps](sortindicator.md#unsafe_componentwillreceiveprops)
* [UNSAFE\_componentWillUpdate](sortindicator.md#unsafe_componentwillupdate)
* [componentDidCatch](sortindicator.md#componentdidcatch)
* [componentDidMount](sortindicator.md#componentdidmount)
* [componentDidUpdate](sortindicator.md#componentdidupdate)
* [componentWillMount](sortindicator.md#componentwillmount)
* [componentWillReceiveProps](sortindicator.md#componentwillreceiveprops)
* [componentWillUnmount](sortindicator.md#componentwillunmount)
* [componentWillUpdate](sortindicator.md#componentwillupdate)
* [cycleDirection](sortindicator.md#cycledirection)
* [forceUpdate](sortindicator.md#forceupdate)
* [getSnapshotBeforeUpdate](sortindicator.md#getsnapshotbeforeupdate)
* [icon](sortindicator.md#icon)
* [render](sortindicator.md#render)
* [setState](sortindicator.md#setstate)
* [shouldComponentUpdate](sortindicator.md#shouldcomponentupdate)

## Constructors

### constructor

\+ **new SortIndicator**(`props`: Readonly\<IProps>): [SortIndicator](sortindicator.md)
...
**Returns:** [SortIndicator](sortindicator.md)

\+ **new SortIndicator**(`props`: IProps, `context?`: any): [SortIndicator](sortindicator.md)
...
*Defined in Work/vortex/src/controls/table/SortIndicator.tsx:29*
...
▸ `Optional`**getSnapshotBeforeUpdate**(`prevProps`: Readonly\<IProps>, `prevState`: Readonly\<{}>): any \| null
...
▸ `Private`**icon**(`direction`: [SortDirection](../globals.md#sortdirection)): string

*Defined in Work/vortex/src/controls/table/SortIndicator.tsx:35*
...
*Defined in Work/vortex/src/controls/table/SortIndicator.tsx:20*
...
▸ **setState**\<K>(`state`: (prevState: Readonly\<{}>, props: Readonly\<IProps>) => Pick\<{}, K> \| {} \| null \| Pick\<{}, K> \| {} \| null, `callback?`: () => void): void
...
Name | Type |
------ | ------ |
`state` | (prevState: Readonly\<{}>, props: Readonly\<IProps>) => Pick\<{}, K> \| {} \| null \| Pick\<{}, K> \| {} \| null |
`callback?` | () => void |
