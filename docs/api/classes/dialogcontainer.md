...
> [Globals](../globals.md) / DialogContainer
...
* [constructor](dialogcontainer.md#constructor)

### Properties

* [context](dialogcontainer.md#context)
* [props](dialogcontainer.md#props)
* [refs](dialogcontainer.md#refs)
* [state](dialogcontainer.md#state)
* [contextType](dialogcontainer.md#contexttype)

### Methods

* [UNSAFE\_componentWillMount](dialogcontainer.md#unsafe_componentwillmount)
* [UNSAFE\_componentWillReceiveProps](dialogcontainer.md#unsafe_componentwillreceiveprops)
* [UNSAFE\_componentWillUpdate](dialogcontainer.md#unsafe_componentwillupdate)
* [componentDidCatch](dialogcontainer.md#componentdidcatch)
* [componentDidMount](dialogcontainer.md#componentdidmount)
* [componentDidUpdate](dialogcontainer.md#componentdidupdate)
* [componentWillMount](dialogcontainer.md#componentwillmount)
* [componentWillReceiveProps](dialogcontainer.md#componentwillreceiveprops)
* [componentWillUnmount](dialogcontainer.md#componentwillunmount)
* [componentWillUpdate](dialogcontainer.md#componentwillupdate)
* [forceUpdate](dialogcontainer.md#forceupdate)
* [getSnapshotBeforeUpdate](dialogcontainer.md#getsnapshotbeforeupdate)
* [render](dialogcontainer.md#render)
* [renderDialog](dialogcontainer.md#renderdialog)
* [setState](dialogcontainer.md#setstate)
* [shouldComponentUpdate](dialogcontainer.md#shouldcomponentupdate)

## Constructors

### constructor

\+ **new DialogContainer**(`props`: Readonly\<[IProps](../globals.md#iprops)>): [DialogContainer](dialogcontainer.md)
...
**Returns:** [DialogContainer](dialogcontainer.md)

\+ **new DialogContainer**(`props`: [IProps](../globals.md#iprops), `context?`: any): [DialogContainer](dialogcontainer.md)
...
*Defined in Work/vortex/src/views/DialogContainer.tsx:26*
...
▸ `Private`**renderDialog**(`dialog`: [IExtDialog](../interfaces/iextdialog.md)): Element

*Defined in Work/vortex/src/views/DialogContainer.tsx:34*

#### Parameters:

Name | Type |
------ | ------ |
`dialog` | [IExtDialog](../interfaces/iextdialog.md) |
