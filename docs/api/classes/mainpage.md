...
▪ `Static` **Body**: [MainPageBody](mainpagebody.md) = Body

*Defined in Work/vortex/src/views/MainPage.tsx:17*
...
*Defined in Work/vortex/src/views/MainPage.tsx:18*
...
*Defined in Work/vortex/src/views/MainPage.tsx:20*
