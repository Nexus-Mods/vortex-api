...
> [Globals](../globals.md) / ActionIconBar
...
* [constructor](actioniconbar.md#constructor)

### Properties

* [context](actioniconbar.md#context)
* [props](actioniconbar.md#props)
* [refs](actioniconbar.md#refs)
* [state](actioniconbar.md#state)
* [ACTION\_PROPS](actioniconbar.md#action_props)
* [contextType](actioniconbar.md#contexttype)

### Methods

* [UNSAFE\_componentWillMount](actioniconbar.md#unsafe_componentwillmount)
* [UNSAFE\_componentWillReceiveProps](actioniconbar.md#unsafe_componentwillreceiveprops)
* [UNSAFE\_componentWillUpdate](actioniconbar.md#unsafe_componentwillupdate)
* [componentDidCatch](actioniconbar.md#componentdidcatch)
* [componentDidMount](actioniconbar.md#componentdidmount)
* [componentDidUpdate](actioniconbar.md#componentdidupdate)
* [componentWillMount](actioniconbar.md#componentwillmount)
* [componentWillReceiveProps](actioniconbar.md#componentwillreceiveprops)
* [componentWillUnmount](actioniconbar.md#componentwillunmount)
* [componentWillUpdate](actioniconbar.md#componentwillupdate)
* [forceUpdate](actioniconbar.md#forceupdate)
* [getSnapshotBeforeUpdate](actioniconbar.md#getsnapshotbeforeupdate)
* [render](actioniconbar.md#render)
* [setState](actioniconbar.md#setstate)
* [shouldComponentUpdate](actioniconbar.md#shouldcomponentupdate)

## Constructors

### constructor

\+ **new ActionIconBar**(`props`: Readonly\<[ExportType](../globals.md#exporttype)>): [ActionIconBar](actioniconbar.md)
...
**Returns:** [ActionIconBar](actioniconbar.md)

\+ **new ActionIconBar**(`props`: [ExportType](../globals.md#exporttype), `context?`: any): [ActionIconBar](actioniconbar.md)
...
▪ `Static` `Private` **ACTION\_PROPS**: string[] = ['filter', 'group', 'instanceId', 'showAll', 'staticElements']

*Defined in Work/vortex/src/controls/IconBar.tsx:364*
...
*Defined in Work/vortex/src/controls/IconBar.tsx:365*
