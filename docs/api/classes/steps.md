...
* [constructor](steps.md#constructor)

### Properties

* [context](steps.md#context)
* [props](steps.md#props)
* [refs](steps.md#refs)
* [state](steps.md#state)
* [Step](steps.md#step)
* [contextType](steps.md#contexttype)

### Methods

* [UNSAFE\_componentWillMount](steps.md#unsafe_componentwillmount)
* [UNSAFE\_componentWillReceiveProps](steps.md#unsafe_componentwillreceiveprops)
* [UNSAFE\_componentWillUpdate](steps.md#unsafe_componentwillupdate)
* [classByIdx](steps.md#classbyidx)
* [componentDidCatch](steps.md#componentdidcatch)
* [componentDidMount](steps.md#componentdidmount)
* [componentDidUpdate](steps.md#componentdidupdate)
* [componentWillMount](steps.md#componentwillmount)
* [componentWillReceiveProps](steps.md#componentwillreceiveprops)
* [componentWillUnmount](steps.md#componentwillunmount)
* [componentWillUpdate](steps.md#componentwillupdate)
* [forceUpdate](steps.md#forceupdate)
* [getSnapshotBeforeUpdate](steps.md#getsnapshotbeforeupdate)
* [render](steps.md#render)
* [setState](steps.md#setstate)
* [shouldComponentUpdate](steps.md#shouldcomponentupdate)

## Constructors

### constructor

\+ **new Steps**(`props`: Readonly\<[IProps](../globals.md#iprops)>): [Steps](steps.md)
...
**Returns:** [Steps](steps.md)

\+ **new Steps**(`props`: [IProps](../globals.md#iprops), `context?`: any): [Steps](steps.md)
...
▪ `Static` **Step**: [Step](step.md) = Step

*Defined in Work/vortex/src/controls/Steps.tsx:13*
...
▸ `Private`**classByIdx**(`currentIdx`: number, `itemIdx`: number): \"done\" \| \"current\" \| \"future\"

*Defined in Work/vortex/src/controls/Steps.tsx:38*
...
*Defined in Work/vortex/src/controls/Steps.tsx:15*
