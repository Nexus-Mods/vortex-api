...
> [Globals](../globals.md) / WindowControls
...
* [constructor](windowcontrols.md#constructor)

### Properties

* [context](windowcontrols.md#context)
* [props](windowcontrols.md#props)
* [refs](windowcontrols.md#refs)
* [state](windowcontrols.md#state)
* [contextType](windowcontrols.md#contexttype)

### Methods

* [UNSAFE\_componentWillMount](windowcontrols.md#unsafe_componentwillmount)
* [UNSAFE\_componentWillReceiveProps](windowcontrols.md#unsafe_componentwillreceiveprops)
* [UNSAFE\_componentWillUpdate](windowcontrols.md#unsafe_componentwillupdate)
* [close](windowcontrols.md#close)
* [componentDidCatch](windowcontrols.md#componentdidcatch)
* [componentDidMount](windowcontrols.md#componentdidmount)
* [componentDidUpdate](windowcontrols.md#componentdidupdate)
* [componentWillMount](windowcontrols.md#componentwillmount)
* [componentWillReceiveProps](windowcontrols.md#componentwillreceiveprops)
* [componentWillUnmount](windowcontrols.md#componentwillunmount)
* [componentWillUpdate](windowcontrols.md#componentwillupdate)
* [forceUpdate](windowcontrols.md#forceupdate)
* [getSnapshotBeforeUpdate](windowcontrols.md#getsnapshotbeforeupdate)
* [minimize](windowcontrols.md#minimize)
* [onMaximize](windowcontrols.md#onmaximize)
* [render](windowcontrols.md#render)
* [setState](windowcontrols.md#setstate)
* [shouldComponentUpdate](windowcontrols.md#shouldcomponentupdate)
* [toggleMaximize](windowcontrols.md#togglemaximize)

## Constructors

### constructor

\+ **new WindowControls**(`props`: Readonly\<{}>): [WindowControls](windowcontrols.md)
...
**Returns:** [WindowControls](windowcontrols.md)

\+ **new WindowControls**(`props`: {}, `context?`: any): [WindowControls](windowcontrols.md)
...
*Defined in Work/vortex/src/views/WindowControls.tsx:81*
...
*Defined in Work/vortex/src/views/WindowControls.tsx:16*
...
*Defined in Work/vortex/src/views/WindowControls.tsx:21*
...
*Defined in Work/vortex/src/views/WindowControls.tsx:69*
...
*Defined in Work/vortex/src/views/WindowControls.tsx:73*
...
*Defined in Work/vortex/src/views/WindowControls.tsx:26*
...
▸ **setState**\<K>(`state`: (prevState: Readonly\<{}>, props: Readonly\<{}>) => Pick\<{}, K> \| {} \| null \| Pick\<{}, K> \| {} \| null, `callback?`: () => void): void
...
*Defined in Work/vortex/src/views/WindowControls.tsx:77*
