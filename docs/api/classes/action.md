...
> [Globals](../globals.md) / Action

# Class: Action

## Hierarchy

* Component\<[IActionProps](../interfaces/iactionprops.md), {}>
...
* [context](action.md#context)
* [props](action.md#props)
* [refs](action.md#refs)
* [state](action.md#state)
* [contextType](action.md#contexttype)

### Methods

* [UNSAFE\_componentWillMount](action.md#unsafe_componentwillmount)
* [UNSAFE\_componentWillReceiveProps](action.md#unsafe_componentwillreceiveprops)
* [UNSAFE\_componentWillUpdate](action.md#unsafe_componentwillupdate)
* [componentDidCatch](action.md#componentdidcatch)
* [componentDidMount](action.md#componentdidmount)
* [componentDidUpdate](action.md#componentdidupdate)
* [componentWillMount](action.md#componentwillmount)
* [componentWillReceiveProps](action.md#componentwillreceiveprops)
* [componentWillUnmount](action.md#componentwillunmount)
* [componentWillUpdate](action.md#componentwillupdate)
* [dismiss](action.md#dismiss)
* [focus](action.md#focus)
* [forceUpdate](action.md#forceupdate)
* [getSnapshotBeforeUpdate](action.md#getsnapshotbeforeupdate)
* [render](action.md#render)
* [setState](action.md#setstate)
* [shouldComponentUpdate](action.md#shouldcomponentupdate)
...
\+ **new Action**(`props`: Readonly\<[IActionProps](../interfaces/iactionprops.md)>): [Action](action.md)
...
Name | Type |
------ | ------ |
`props` | Readonly\<[IActionProps](../interfaces/iactionprops.md)> |

**Returns:** [Action](action.md)

\+ **new Action**(`props`: [IActionProps](../interfaces/iactionprops.md), `context?`: any): [Action](action.md)
...
Name | Type |
------ | ------ |
`props` | [IActionProps](../interfaces/iactionprops.md) |
`context?` | any |
...
• `Readonly` **props**: Readonly\<[IActionProps](../interfaces/iactionprops.md)> & Readonly\<{ children?: ReactNode  }>
...
▸ `Optional`**UNSAFE_componentWillReceiveProps**(`nextProps`: Readonly\<[IActionProps](../interfaces/iactionprops.md)>, `nextContext`: any): void
...
Name | Type |
------ | ------ |
`nextProps` | Readonly\<[IActionProps](../interfaces/iactionprops.md)> |
`nextContext` | any |
...
▸ `Optional`**UNSAFE_componentWillUpdate**(`nextProps`: Readonly\<[IActionProps](../interfaces/iactionprops.md)>, `nextState`: Readonly\<{}>, `nextContext`: any): void
...
▸ `Optional`**componentDidUpdate**(`prevProps`: Readonly\<[IActionProps](../interfaces/iactionprops.md)>, `prevState`: Readonly\<{}>, `snapshot?`: any): void
...
Name | Type |
------ | ------ |
`prevProps` | Readonly\<[IActionProps](../interfaces/iactionprops.md)> |
`prevState` | Readonly\<{}> |
`snapshot?` | any |
...
▸ `Optional`**componentWillReceiveProps**(`nextProps`: Readonly\<[IActionProps](../interfaces/iactionprops.md)>, `nextContext`: any): void
...
▸ `Optional`**componentWillUpdate**(`nextProps`: Readonly\<[IActionProps](../interfaces/iactionprops.md)>, `nextState`: Readonly\<{}>, `nextContext`: any): void
...
*Defined in Work/vortex/src/views/Dialog.tsx:59*
...
▸ `Private`**focus**(`ref`: any): void

*Defined in Work/vortex/src/views/Dialog.tsx:53*
...
▸ `Optional`**getSnapshotBeforeUpdate**(`prevProps`: Readonly\<[IActionProps](../interfaces/iactionprops.md)>, `prevState`: Readonly\<{}>): any \| null
...
*Defined in Work/vortex/src/views/Dialog.tsx:38*
...
▸ **setState**\<K>(`state`: (prevState: Readonly\<{}>, props: Readonly\<[IActionProps](../interfaces/iactionprops.md)>) => Pick\<{}, K> \| {} \| null \| Pick\<{}, K> \| {} \| null, `callback?`: () => void): void
...
Name | Type |
------ | ------ |
`state` | (prevState: Readonly\<{}>, props: Readonly\<[IActionProps](../interfaces/iactionprops.md)>) => Pick\<{}, K> \| {} \| null \| Pick\<{}, K> \| {} \| null |
`callback?` | () => void |
...
▸ `Optional`**shouldComponentUpdate**(`nextProps`: Readonly\<[IActionProps](../interfaces/iactionprops.md)>, `nextState`: Readonly\<{}>, `nextContext`: any): boolean
...
*Defined in Work/vortex/src/views/Notification.tsx:26*
