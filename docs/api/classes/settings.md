...
* [mStartupPath](settings.md#mstartuppath)
* [mStartupSettings](settings.md#mstartupsettings)
* [nextState](settings.md#nextstate)

### Methods

* [UNSAFE\_componentWillMount](settings.md#unsafe_componentwillmount)
* [UNSAFE\_componentWillReceiveProps](settings.md#unsafe_componentwillreceiveprops)
* [UNSAFE\_componentWillUpdate](settings.md#unsafe_componentwillupdate)
* [changeStartup](settings.md#changestartup)
* [componentDidCatch](settings.md#componentdidcatch)
* [componentDidMount](settings.md#componentdidmount)
* [componentDidUpdate](settings.md#componentdidupdate)
* [componentWillMount](settings.md#componentwillmount)
* [componentWillReceiveProps](settings.md#componentwillreceiveprops)
* [componentWillUnmount](settings.md#componentwillunmount)
* [componentWillUpdate](settings.md#componentwillupdate)
* [getSnapshotBeforeUpdate](settings.md#getsnapshotbeforeupdate)
* [initState](settings.md#initstate)
* [render](settings.md#render)
* [renderTab](settings.md#rendertab)
* [renderTabElement](settings.md#rendertabelement)
* [setCurrentPage](settings.md#setcurrentpage)
* [shouldComponentUpdate](settings.md#shouldcomponentupdate)
* [sortByPriority](settings.md#sortbypriority)

### Object literals

* [contextTypes](settings.md#contexttypes)

## Constructors

### constructor

\+ **new Settings**(`props`: [IProps](../globals.md#iprops)): [Settings](settings.md)

*Defined in Work/vortex/src/views/Settings.tsx:58*
...
• `Private` **mStartupPath**: string = path.join(remote.app.getPath('appData'), remote.app.name, 'startup.json')

*Defined in Work/vortex/src/views/Settings.tsx:55*
...
▸ `Private`**changeStartup**(`key`: string, `value`: any): void

*Defined in Work/vortex/src/views/Settings.tsx:155*
...
*Defined in Work/vortex/src/views/Settings.tsx:70*
...
▸ `Private`**renderTab**(`page`: [ICombinedSettingsPage](../interfaces/icombinedsettingspage.md)): Element

*Defined in Work/vortex/src/views/Settings.tsx:101*

#### Parameters:

Name | Type |
------ | ------ |
`page` | [ICombinedSettingsPage](../interfaces/icombinedsettingspage.md) |
...
▸ `Private`**renderTabElement**(`page`: [ISettingsPage](../interfaces/isettingspage.md), `idx`: number): Element

*Defined in Work/vortex/src/views/Settings.tsx:130*

#### Parameters:

Name | Type |
------ | ------ |
`page` | [ISettingsPage](../interfaces/isettingspage.md) |
`idx` | number |
...
▸ `Private`**setCurrentPage**(`page`: any): void

*Defined in Work/vortex/src/views/Settings.tsx:151*
...
▸ `Private`**sortByPriority**(`lhs`: [ICombinedSettingsPage](../interfaces/icombinedsettingspage.md), `rhs`: [ICombinedSettingsPage](../interfaces/icombinedsettingspage.md)): number

*Defined in Work/vortex/src/views/Settings.tsx:147*

#### Parameters:

Name | Type |
------ | ------ |
`lhs` | [ICombinedSettingsPage](../interfaces/icombinedsettingspage.md) |
`rhs` | [ICombinedSettingsPage](../interfaces/icombinedsettingspage.md) |
