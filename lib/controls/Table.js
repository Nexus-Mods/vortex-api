...
class SuperTable extends ComponentEx_1.ComponentEx {
    ...
    componentWillReceiveProps(newProps) {
        if ((newProps.attributeState !== this.props.attributeState)
            ...
            if (Object.keys(newProps.attributeState).find(id => this.props.attributeState[id].enabled !== newProps.attributeState[id].enabled)) {
    ...
    renderTableActions(hasActions) {
        ...
        return (React.createElement(MyTable_1.TH, { className: `table-${tableId} header-action` },
            React.createElement("div", null,
                ...
                columnToggles.length > 0 ? (React.createElement(IconBar_1.default, { id: `${tableId}-tableactions`, group: `${tableId}-action-icons-multi`, className: 'table-actions', staticElements: columnToggles, collapse: 'force', icon: 'settings' })) : null)));
    }
