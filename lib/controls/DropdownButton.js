...
class MyDropdownButton extends React.Component {
    ...
    render() {
        ...
        const relayProps = _.omit(this.props, ['container', 'dropup', 'onToggle', 'split']);
        const Comp = this.props.split ? react_bootstrap_1.SplitButton : react_bootstrap_1.DropdownButton;
        return React.createElement(Comp, Object.assign({ dropup: up, pullRight: right, onToggle: this.onToggle }, relayProps));
    }
    get bounds() {
