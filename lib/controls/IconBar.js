    ...
    constructor(props) {
        ...
        this.renderIconInner = (icon, index, forceButtonType) => {
            ...
            if (icon.icon !== undefined) {
                ...
                return (React.createElement(ToolbarIcon_1.default, { key: id, id: id, instanceId: instanceIds, icon: hasIcon ? icon.icon : undefined, text: hasText ? icon.title : undefined, tooltip: icon.title, onClick: icon.action, placement: tooltipPlacement }));
            }
            else {
