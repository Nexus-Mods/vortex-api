...
class MenuAction extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(react_bootstrap_1.MenuItem, { eventKey: id, onSelect: this.trigger, disabled: action.show !== true, title: genTooltip(t, action.show) },
...
class IconBar extends React.Component {
    constructor(props) {
        ...
        this.renderMenuItem = (icon, index) => {
            ...
            if ((icon.icon === null) && (icon.component === undefined)) {
                return (React.createElement(react_bootstrap_1.MenuItem, { className: 'menu-separator-line', key: id, disabled: true }, t(icon.title)));
            }
        ...
        this.renderIconInner = (icon, index, forceButtonType) => {
            ...
            if (icon.icon !== undefined) {
                ...
                return (React.createElement(ToolbarIcon_1.default, { key: id, id: id, instanceId: instanceIds, icon: hasIcon ? icon.icon : undefined, text: hasText ? t(icon.title) : undefined, tooltip: t(icon.title), onClick: icon.action, placement: tooltipPlacement }));
            }
            else {
    ...
    render() {
        const { actions, collapse, icon, id, orientation, className, style } = this.props;
        const classes = [];
        if (className) {
