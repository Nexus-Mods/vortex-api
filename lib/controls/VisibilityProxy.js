 ...
 */
class VisibilityProxy extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (React.createElement("div", Object.assign({}, _.omit(this.props, ['container', 'placeholder', 'content', 'startVisible'])), (this.state.visible)
            ? this.props.content()
