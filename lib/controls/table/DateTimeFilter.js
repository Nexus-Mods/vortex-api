...
class DateTimeFilterComponent extends ComponentEx_1.ComponentEx {
    ...
    render() {
        ...
        return (React.createElement(react_bootstrap_1.InputGroup, { className: 'datetime-filter' },
            ...
            React.createElement(react_datepicker_1.default, { selected: util_1.truthy(filt.value) ? moment(filt.value) : null, onChange: this.changeFilter, locale: this.context.api.locale(), isClearable: true, className: 'datetime-picker' })));
    }
}
