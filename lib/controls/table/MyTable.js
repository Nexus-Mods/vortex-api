...
class TH extends React.Component {
    render() {
        ...
        return (React.createElement("div", Object.assign({ style: Object.assign({}, style, { display: 'table-cell' }), className: classes.join(' '), ref: domRef }, _.omit(this.props, ['style', 'className', 'domRef'])), children));
    }
}
exports.TH = TH;
function TR(props) {
