...
class QuickLauncher extends ComponentEx_1.ComponentEx {
    constructor(props) {
        ...
        this.start = () => {
            ...
            // });
            this.context.api.events.emit('mixpanel-track-event', new MixpanelEvents_1.AppStartGameEvent(profile.gameId, numberOfEnabledModsExcludingCollections, numberOfEnabledCollections));
