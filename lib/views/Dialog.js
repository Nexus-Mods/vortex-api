...
class Dialog extends ComponentEx_1.ComponentEx {
        ...
        this.renderCheckbox = (checkbox, content) => {
            ...
            const text = checkbox.bbcode !== undefined
                ? (0, bbcode_1.default)(translated
                    ? t(checkbox.bbcode, { replace: content.parameters, count: (_b = content.parameters) === null || _b === void 0 ? void 0 : _b.count })
                    : checkbox.bbcode, (_c = content.options) === null || _c === void 0 ? void 0 : _c.bbcodeContext)
                : (translated
                    ? t(checkbox.text, { replace: content.parameters, count: (_d = content.parameters) === null || _d === void 0 ? void 0 : _d.count })
                    : checkbox.text);
    ...
    renderContent(content) {
        ...
        if (content.bbcode !== undefined) {
            ...
            controls.push({ id: 'bbcode', control: (React.createElement("div", { key: 'dialog-content-bbcode', className: 'dialog-content-bbcode' }, (0, bbcode_1.default)(bbcodeContent, (_c = content.options) === null || _c === void 0 ? void 0 : _c.bbcodeContext))) });
        }
        if (content.md !== undefined) {
            controls.push({ id: 'md', control: (React.createElement("div", { key: 'dialog-content-markdown', className: 'dialog-content-markdown' },
                    React.createElement(react_markdown_1.default, null, t(content.md, { replace: content.parameters, count: (_d = content.parameters) === null || _d === void 0 ? void 0 : _d.count })))) });
        }
        ...
        if (content.links !== undefined) {
            controls.push({ id: 'links', control: (React.createElement("div", { key: 'dialog-form-links' }, content.links.map(((_e = content.options) === null || _e === void 0 ? void 0 : _e.linksAsButtons) ? this.renderButton : this.renderLink))) });
        }
