 ...
 */
exports.setDownloadSpeed = safeCreateAction_1.default('SET_DOWNLOAD_SPEED', speed => speed, () => ({ forward: false }));
exports.setDownloadSpeeds = safeCreateAction_1.default('SET_DOWNLOAD_SPEEDS', speeds => speeds);
/**
