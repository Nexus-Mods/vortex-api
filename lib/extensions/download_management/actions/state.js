 ...
 */
exports.finishDownload = (0, safeCreateAction_1.default)("FINISH_DOWNLOAD", (id, state, failCause) => ({
    id,
    state,
    failCause,
}));
exports.setDownloadHash = (0, safeCreateAction_1.default)("SET_DOWNLOAD_HASH", (id, fileMD5) => ({ id, fileMD5 }));
exports.setDownloadHashByFile = (0, safeCreateAction_1.default)("SET_DOWNLOAD_HASH_BY_FILE", (fileName, fileMD5, fileSize) => ({
    fileName,
    fileMD5,
    fileSize,
}));
...
exports.removeDownloadSilent = (0, safeCreateAction_1.default)("REMOVE_DOWNLOAD_SILENT", (id) => ({ id }));
/**
 ...
 * in the download.
 */
exports.addLocalDownload = (0, safeCreateAction_1.default)("ADD_LOCAL_DOWNLOAD", (id, game, localPath, fileSize) => ({
    id,
    game,
    localPath,
    fileSize,
