...
class DownloadWorker {
    constructor(api, job, progressCB, finishCB, headersCB, userAgent, throttle, getAgent) {
        ...
        this.mInFlightWrites = 0; // Track writes sent to dataCB but not yet confirmed
        this.assignJob = (job, jobUrl) => {
            ...
            (0, log_1.log)("debug", "requesting range", {
                id: job.workerId,
                offset: job.offset,
                size: job.size,
            });
        ...
        this.startDownload = (job, jobUrl, electronCookies) => {
            ...
            try {
                ...
                this.mRequest = lib.request(requestOptions, (res) => {
                    ...
                    (0, log_1.log)("debug", "downloading from", {
                    ...
                    try {
                        ...
                        (0, log_1.log)("warn", "URL encoding failed, using original", {
                            url: jobUrlString,
                            error: err.message,
                        });
        ...
        this.stalled = () => {
            if (this.mRequest !== undefined) {
                if (this.mStallResets <= 0) {
                    ...
                    const stalled = new CustomErrors_1.StalledError(`Download stalled for ${STALL_TIMEOUT}ms with no progress (url: ${this.mUrl})`);
                    return this.handleError(stalled);
                }
                (0, log_1.log)("info", "download stalled, restarting worker", {
                    url: this.mUrl,
        ...
        this.handleError = (err) => {
            ...
            const is416Error = err instanceof CustomErrors_1.HTTPError && err.statusCode === 416;
            ...
            if (isNetworkError &&
                ...
                this.mEnded = true;
                (_f = (_e = this.mJob).errorCB) === null || _f === void 0 ? void 0 : _f.call(_e, err);
            ...
            const isTimeoutError = ["ETIMEDOUT", "ESOCKETTIMEDOUT", "ECONNRESET", "ENOTFOUND"].includes(err.code) ||
                ((_g = err.message) === null || _g === void 0 ? void 0 : _g.includes("Request timeout")) ||
                ((_h = err.message) === null || _h === void 0 ? void 0 : _h.includes("ETIMEDOUT"));
            ...
            if (shouldRetry) {
                if (this.mNetworkRetries < DownloadWorker.MAX_NETWORK_RETRIES) {
                    ...
                    (0, log_1.log)("info", "retrying chunk after network error", {
                        ...
                        errorCode: err.code,
                        errorMessage: err.message,
                        httpStatusCode: err instanceof CustomErrors_1.HTTPError ? err.statusCode : undefined,
                    ...
                    setTimeout(() => {
                        if (!this.mEnded) {
                            ...
                            if (is416Error) {
                                (0, log_1.log)("debug", "resetting chunk range after 416 error", {
                                    id: this.mJob.workerId,
                    ...
                    this.mEnded = true;
                    (_k = (_j = this.mJob).errorCB) === null || _k === void 0 ? void 0 : _k.call(_j, err);
                    this.mFinishCB(false);
                }
            }
            else {
                ...
                (_m = (_l = this.mJob).errorCB) === null || _m === void 0 ? void 0 : _m.call(_l, err);
                this.abort(false);
            }
        };
        this.abort = (paused) => {
        ...
        this.handleResponse = (response, jobUrl) => {
            ...
            (0, log_1.log)("debug", "retrieving range", {
                id: this.mJob.workerId,
        ...
        this.writeBuffer = (str) => {
            ...
            try {
                ...
                (0, log_1.log)("warn", "failed to merge buffers", {
        ...
        this.handleData = (data, str) => {
            if (this.mEnded || ["paused", "finished"].includes(this.mJob.state)) {
                (0, log_1.log)("debug", "got data after ended", {
...
class DownloadManager {
    ...
    constructor(api, downloadPath, maxWorkers, maxChunks, speedCB, userAgent, protocolHandlers, maxBandwidth) {
            ...
            return fs
                ...
                download = {
                    ...
                    finalName: fileName !== undefined
                        ? bluebird_1.default.resolve(path.join(destPath, path.basename(filePath)))
                        : undefined,
                    error: false,
                    urls,
        ...
        this.resolveUrls = (urls, name, friendlyName) => {
            ...
            return () => {
                if (cache === undefined) {
                    ...
                    }, { urls: [], meta: {}, updatedUrls: [] }).then((result) => {
                        return { result, error };
                    });
                }
        ...
        this.cancelDownload = (download, err) => {
            const isUserCanceled = err instanceof CustomErrors_1.UserCanceled;
            if (isUserCanceled) {
        ...
        this.cleanupOrphanedPlaceholder = (download) => {
            if (download.size === 0 || download.received < download.size) {
                (0, log_1.log)("debug", "cleaning up orphaned placeholder file", {
                    id: download.id,
                ...
                if (download.assembler !== undefined && !download.assembler.isClosed()) {
                    download.assembler
                        ...
                        return fs.removeAsync(download.tempName).catch((err) => {
                            if (err.code !== "ENOENT") {
                                (0, log_1.log)("warn", "failed to remove orphaned placeholder", {
                ...
                if (starving) {
                    ...
                    if (this.shouldRestartSlowWorker(job.workerId, download)) {
                        ...
                        if (this.mBusyWorkers[job.workerId]) {
                            ...
                            (0, log_1.log)("warn", "attempted to restart non-existent worker", {
                                workerId: job.workerId,
                            });
                        }
                    }
        ...
        this.startJob = (download, job) => {
            if (download.assemblerProm === undefined) {
                download.assemblerProm = FileAssembler_1.default.create(download.tempName).tap((assembler) => assembler.setTotalSize(download.size));
            }
        ...
        this.makeDataCB = (download) => {
            ...
            return (offset, data) => {
                ...
                return download.assembler
                    ...
                    .then((synced) => {
                    const urls = Array.isArray(download.urls)
                        ? download.urls
                        : undefined;
                    ...
                    if (shouldUpdate && !pendingProgressUpdate) {
                        ...
                        setImmediate(() => {
                            ...
                            download.progressCB(receivedNow, download.size, synced ? download.chunks.map(this.toStoredChunk) : undefined, download.chunkable, urls, download.tempName);
                        });
                    }
        ...
        this.updateDownload = (download, fileSize, fileName, chunkable) => {
                ...
                newName
                    ...
                    if (!download.assembler.isClosed()) {
                        return download.assembler
                            ...
                            if (err instanceof CustomErrors_1.ProcessCanceled &&
                                ...
                                return fs
                                    ...
                                    this.mApi.store.dispatch((0, state_1.setDownloadFilePath)(download.id, newFileName));
                                })
                                    .catch((fsErr) => {
                                    ...
                                    return fs
                                        ...
                                        .catch(() => null)
                                        .then(() => bluebird_1.default.reject(fsErr));
                                });
                            }
                        ...
                        return fs
                            ...
                            (0, log_1.log)("warn", "failed to rename closed download file", {
                                error: err.message,
                                from: oldTempName,
                                to: resolvedName,
                            });
                    ...
                    .catch((err) => {
                    (0, log_1.log)("error", "failed to update download name", {
                        error: err.message,
                        fileName,
            ...
            if (fileSize > this.mMinChunkSize && chunkable) {
                ...
                (0, log_1.log)("debug", "downloading file in chunks", {
                    size: chunkSize,
        ...
        this.useExistingFile = (download, job, fileName) => {
            ...
            (0, log_1.log)("debug", "using existing file for download", {
            ...
            download.assembler
                ...
                .catch((err) => err.code !== "ENOENT" ? bluebird_1.default.reject(err) : bluebird_1.default.resolve()))
        ...
        this.finishChunk = (download, job, paused) => {
            this.stopWorker(job.workerId);
            (0, log_1.log)("debug", "stopping chunk worker", {
                paused,
                id: job.workerId,
                offset: job.offset,
                size: job.size,
            ...
            if (!paused && hasRemainingData) {
                ...
                if (job.requeues >= MAX_CHUNK_REQUEUES) {
                    (0, log_1.log)("warn", "chunk exceeded max requeues, marking download as errored", {
                        id: download.id,
                        workerId: job.workerId,
                        remaining: job.size,
                    ...
                    (0, log_1.log)("info", "chunk finished with remaining data, requeuing", {
                        id: download.id,
                        workerId: job.workerId,
                        remaining: job.size,
            ...
            const activeChunk = download.chunks.find((chunk) => {
            ...
            if (activeChunk === undefined) {
                ...
                download.assembler
                    ...
                    if (currentExt === "") {
                        (0, log_1.log)("info", "download has no extension, detecting from magic header", {
                            id: download.id,
                            tempName: download.tempName,
                        });
                        return bluebird_1.default.resolve(this.detectFileExtensionFromMagic(download.tempName)).then((detectedExt) => {
                            if (detectedExt) {
                                const newPath = download.tempName + detectedExt;
                                (0, log_1.log)("info", "renaming file with detected extension", {
                                ...
                                return fs
                                    ...
                                    .catch((err) => {
                                    (0, log_1.log)("error", "failed to rename file with detected extension", {
                                        error: err.message,
                                        from: download.tempName,
                                        to: newPath,
                                    });
                                ...
                                (0, log_1.log)("warn", "could not detect file type for extensionless file", {
                                    file: download.tempName,
                                });
                            }
                        });
                    ...
                    if (download.finalName !== undefined) {
                        return download.finalName.then((resolvedPath) => {
                            ...
                            if (download.tempName !== resolvedPath) {
                                (0, log_1.log)("debug", "renaming download", {
                                    from: download.tempName,
                                    to: resolvedPath,
                                });
    ...
    cleanupCompletedDownloads() {
        ...
        setImmediate(() => {
            ...
            this.mQueue = this.mQueue.filter((download) => {
                ...
                // size = confirmedSize - confirmedReceived (remaining bytes)
                const hasPausedChunksWithData = download.chunks.some((chunk) => chunk.state === "paused" && chunk.size > 0);
                // Only remove if:
    ...
    detectFileExtensionFromMagic(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const fd = yield fs.openAsync(filePath, "r");
                const buffer = Buffer.alloc(16); // Read first 16 bytes for magic detection
                try {
                    yield fs.readAsync(fd, buffer, 0, 16, 0);
                }
                finally {
                ...
                (0, log_1.log)("debug", "could not detect archive type from magic header", {
                    filePath,
                ...
                (0, log_1.log)("warn", "failed to read file for magic header detection", {
                    filePath,
                    error: err.message,
                });
                return null;
