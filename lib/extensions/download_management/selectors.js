...
exports.downloadByIds = exports.activeDownloads = exports.queueClearingDownloads = exports.downloadsForActiveGame = exports.downloadsForGame = exports.downloadPath = void 0;
...
exports.downloadByIds = (0, reselect_1.createSelector)(downloadFiles, (state, identifiers) => identifiers, (files, identifiers) => {
    return Object.keys(files).find(dlId => {
