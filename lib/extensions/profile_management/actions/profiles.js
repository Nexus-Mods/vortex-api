 ...
 */
exports.setProfile = safeCreateAction_1.default('SET_PROFILE', profileId => profileId);
exports.removeProfile = safeCreateAction_1.default('REMOVE_PROFILE', profileId => profileId);
/**
...
exports.setProfileActivated = safeCreateAction_1.default('SET_PROFILE_ACTIVATED', (active) => active);
