 ...
 */
exports.setModEnabled = (0, safeCreateAction_1.default)("SET_MOD_ENABLED", (profileId, modId, enable) => ({
    profileId,
    modId,
    enable,
}));
exports.forgetMod = (0, safeCreateAction_1.default)("FORGET_PROFILE_MOD", (profileId, modId) => ({ profileId, modId }));
exports.setFeature = (0, safeCreateAction_1.default)("SET_PROFILE_FEATURE", (profileId, featureId, value) => ({
    profileId,
    featureId,
    value,
}));
