...
const getCollectionModByReference = (state, searchParams) => {
    ...
    return Object.values(mods).find((mod) => {
        var _a;
        const ref = (_a = mod.rule) === null || _a === void 0 ? void 0 : _a.reference;
        if (!ref)
            return false;
        ...
        if (searchParams.fileMD5 && ref.fileMD5 === searchParams.fileMD5)
            return true;
        if (searchParams.fileId && ref.id === searchParams.fileId)
            return true;
