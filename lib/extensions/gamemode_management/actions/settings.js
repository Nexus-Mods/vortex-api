 ...
 */
exports.setGamePath = (0, safeCreateAction_1.default)('SET_GAME_PATH', (gameId, gamePath, store, exePath) => ({ gameId, gamePath, store, exePath }));
/**
 ...
 */
exports.setToolVisible = (0, safeCreateAction_1.default)('SET_TOOL_VISIBLE', (gameId, toolId, visible) => ({ gameId, toolId, visible }));
/**
