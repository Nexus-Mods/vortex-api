    ...
    render() {
        ...
        return (React.createElement(MainPage_1.default, { domRef: this.setRef },
            React.createElement(MainPage_1.default.Header, null,
                React.createElement(IconBar_1.default, { group: 'game-icons', staticElements: this.buttons, className: 'menubar', t: t }),
                React.createElement("div", { className: 'flex-fill' }),
                React.createElement(IconBar_1.default, { id: 'gamepicker-layout-list', group: 'gamepicker-layout-icons', staticElements: [], className: 'menubar', t: t },
...
function mapDispatchToProps(dispatch) {
    return {
        onSetPickerLayout: (layout) => dispatch(settings_1.setPickerLayout(layout)),
    };
}
