...
exports.nexusIdsFromDownloadId = (0, reselect_1.createSelector)(downloadFiles, (state, downloadId) => downloadId, (files, downloadId) => {
    ...
    if (((_c = (_b = (_a = dl === null || dl === void 0 ? void 0 : dl.modInfo) === null || _a === void 0 ? void 0 : _a.nexus) === null || _b === void 0 ? void 0 : _b.ids) === null || _c === void 0 ? void 0 : _c.gameId) == null &&
        ((_e = (_d = dl === null || dl === void 0 ? void 0 : dl.modInfo) === null || _d === void 0 ? void 0 : _d.meta) === null || _e === void 0 ? void 0 : _e.gameId) == null) {
        return undefined;
    }
    const numericGameId = (0, util_2.nexusGames)().find((g) => {
        var _a, _b, _c, _d, _e;
        return g.domain_name ===
            (((_c = (_b = (_a = dl.modInfo) === null || _a === void 0 ? void 0 : _a.nexus) === null || _b === void 0 ? void 0 : _b.ids) === null || _c === void 0 ? void 0 : _c.gameId) || ((_e = (_d = dl === null || dl === void 0 ? void 0 : dl.modInfo) === null || _d === void 0 ? void 0 : _d.meta) === null || _e === void 0 ? void 0 : _e.domainName));
    });
    return {
