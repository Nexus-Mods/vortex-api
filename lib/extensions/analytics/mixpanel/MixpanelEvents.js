 ...
 */
class ModsDownloadStartedClientEvent {
    constructor(mod_id, file_id, game_id, mod_uid, file_uid) {
        this.eventName = "mods_download_started_client";
        this.properties = { mod_id, file_id, game_id, mod_uid, file_uid };
    }
}
exports.ModsDownloadStartedClientEvent = ModsDownloadStartedClientEvent;
/** DONE
