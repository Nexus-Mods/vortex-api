...
exports.loadCategories = (0, safeCreateAction_1.default)("LOAD_CATEGORIES", (gameId, gameCategories) => ({
    gameId,
    gameCategories,
}));
exports.setCategory = (0, safeCreateAction_1.default)("SET_CATEGORY", (gameId, id, category) => ({
    gameId,
    id,
    category,
}));
...
exports.updateCategories = (0, safeCreateAction_1.default)("UPDATE_CATEGORIES", (gameId, gameCategories) => ({
    gameId,
    gameCategories,
}));
exports.renameCategory = (0, safeCreateAction_1.default)("RENAME_CATEGORY", (gameId, categoryId, name) => ({
    gameId,
    categoryId,
    name,
}));
