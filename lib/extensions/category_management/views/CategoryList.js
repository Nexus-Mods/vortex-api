...
const ActionDropdown_1 = require("../../../controls/ActionDropdown");
...
class CategoryList extends ComponentEx_1.ComponentEx {
    constructor(props) {
        ...
        this.generateNodeProps = (rowInfo) => {
            ...
            return {
                buttons: [
                    (React.createElement(ActionDropdown_1.default, { className: 'category-buttons', group: 'category-icons', staticElements: actions, instanceId: rowInfo.node.categoryId })),
                ],
            };
        };
    ...
    render() {
        ...
        return (React.createElement("div", { className: 'categories-dialog' },
            React.createElement(IconBar_1.default, { group: 'categories-icons', staticElements: this.mButtons, className: 'menubar categories-icons', t: t }),
