 ...
 */
export declare function resolveCategoryPath(category: string | number, state: IState): string;
 ...
 * @param {Redux.Store<any>} store
 */
export declare function resolveCategoryName(category: string | number, state: IState): string;
