...
exports.setModArchiveId = (0, safeCreateAction_1.default)("SET_MOD_ARCHIVEID", (gameId, modId, archiveId) => ({
    gameId,
    modId,
    archiveId,
}));
 ...
 */
exports.setModState = (0, safeCreateAction_1.default)("SET_MOD_STATE", (gameId, modId, modState) => ({
    gameId,
    modId,
    modState,
}));
 ...
 */
exports.setModInstallationPath = (0, safeCreateAction_1.default)("SET_MOD_INSTALLATION_PATH", (gameId, modId, installPath) => ({
    gameId,
    modId,
    installPath,
}));
 ...
 */
exports.setModAttribute = (0, safeCreateAction_1.default)("SET_MOD_ATTRIBUTE", (gameId, modId, attribute, value) => ({
    gameId,
    modId,
    attribute,
    value,
...
exports.setINITweakEnabled = (0, safeCreateAction_1.default)("SET_TWEAK_ENABLED", (gameId, modId, tweak, enabled) => ({
    gameId,
    modId,
    tweak,
    enabled,
 ...
 */
exports.setFileOverride = (0, safeCreateAction_1.default)("SET_FILE_OVERRIDE", (gameId, modId, files) => ({
    gameId,
    modId,
    files,
}));
