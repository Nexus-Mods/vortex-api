...
class InstallContext {
    constructor(gameMode, api, silent, notificationAggregator, sourceModId) {
        this.mSilent = false;
    ...
    setProgress(phase, percent) {
        ...
        if ((percent === undefined)
            ...
            || (Math.abs(percent - ((_a = this.mLastProgress) !== null && _a !== void 0 ? _a : 0)) >= 5)) {
    ...
    startInstallCB(id, gameId, archiveId) {
        ...
        if ((nexusIds === null || nexusIds === void 0 ? void 0 : nexusIds.fileId) != null && !isCollection) {
            const { modUID, fileUID } = (0, UIDs_1.makeModAndFileUIDs)(nexusIds.numericGameId.toString(), nexusIds.modId, nexusIds.fileId);
    ...
    reportError(message, details, allowReport, replace) {
        ...
        if (this.mNotificationAggregator && this.mSourceModId) {
            ...
            if (this.mNotificationAggregator.isAggregating(aggregationId)) {
                ...
                this.mNotificationAggregator.addNotification(aggregationId, 'error', message, errorMessage, this.mAddedId || this.mIndicatorId || 'unknown', { allowReport });
                return;
            }
        }
