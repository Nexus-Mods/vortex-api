...
function findCollectionByDownload(state, download, downloadId) {
    ...
    if (!matchingRule) {
        (0, log_1.log)('debug', 'No matching rule found in collection for download', { downloadId, referenceTag });
        return null;
    }
...
class InstallManager {
    ...
    installInner(api, archivePath, tempPath, destinationPath, gameId, installContext, installationZip, forceInstaller, installChoices, extractList, unattended, details) {
        ...
        return extractProm
            ...
            if (hasCSScripts) {
                const modName = ((_a = details === null || details === void 0 ? void 0 : details.modReference) === null || _a === void 0 ? void 0 : _a.id) || path.basename(archivePath, path.extname(archivePath));
                ...
                const dialogResult = yield ((_b = api.showDialog) === null || _b === void 0 ? void 0 : _b.call(api, 'question', t(`Unsafe Mod Detected`), {
                    message: t(`"{{modName}}" contains C# scripts that can run code on your computer.\n` +
