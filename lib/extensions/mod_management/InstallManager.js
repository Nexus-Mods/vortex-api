...
class InstallManager {
        ...
        allDownloadedMods.forEach((mod) => {
            ...
            if (downloads[downloadId].state === 'finished') {
                ...
                if (!hasPendingOrActive) {
                    ...
                    (0, log_1.log)('debug', 'Download blocked by pending/active installation', { downloadId });
                }
            }
            else {
    ...
    findDownloadForMod(reference, downloads) {
        ...
        const downloadId = (0, dependencies_1.findDownloadByRef)(reference, downloads);
        if (downloadId) {
            return downloadId;
        }
        // Try filename match
        ...
        if (reference) {
            const altDownloadId = Object.keys(downloads).find(dlId => {
                ...
                const identifiers = {
                    ...
                    gameId: ((_c = (_b = (_a = download.modInfo) === null || _a === void 0 ? void 0 : _a.nexus) === null || _b === void 0 ? void 0 : _b.ids) === null || _c === void 0 ? void 0 : _c.gameId) || ((_d = download.modInfo) === null || _d === void 0 ? void 0 : _d.gameId),
                    modId: (_g = (_f = (_e = download.modInfo) === null || _e === void 0 ? void 0 : _e.nexus) === null || _f === void 0 ? void 0 : _f.ids) === null || _g === void 0 ? void 0 : _g.modId,
                    fileId: (_k = (_j = (_h = download.modInfo) === null || _h === void 0 ? void 0 : _h.nexus) === null || _j === void 0 ? void 0 : _j.ids) === null || _k === void 0 ? void 0 : _k.fileId
                };
