...
const cSharpScriptAllowList_1 = require("./util/cSharpScriptAllowList");
...
const util_2 = require("../collections_integration/util");
...
function findCollectionByDownload(state, download, sourceModId) {
    var _a, _b, _c;
    const gameId = (_a = (0, selectors_1.activeProfile)(state)) === null || _a === void 0 ? void 0 : _a.gameId;
    if (!gameId) {
        (0, log_1.log)('debug', 'No active game profile', { downloadId: download.id });
        return null;
    }
    if (sourceModId != null) {
        const mods = state.persistent.mods[gameId];
        const collectionMod = mods === null || mods === void 0 ? void 0 : mods[sourceModId];
        if (!collectionMod || !(download === null || download === void 0 ? void 0 : download.id)) {
            (0, log_1.log)('debug', 'No collection mod found for sourceModId', { downloadId: download.id, sourceModId });
            return null;
        }
        const lookup = (0, dependencies_1.lookupFromDownload)(download);
        const matchingRule = collectionMod.rules.find(rule => (0, testModReference_1.default)(lookup, rule.reference));
        if (matchingRule) {
    ...
    if (!(activeCollection === null || activeCollection === void 0 ? void 0 : activeCollection.collectionId)) {
        (0, log_1.log)('debug', 'No active collection installation found', { downloadId: download.id });
        return null;
    }
    const matchingRule = (0, selectors_2.getCollectionModByReference)(state, {
        tag: (_b = download.modInfo) === null || _b === void 0 ? void 0 : _b.referenceTag,
        fileMD5: download.fileMD5,
        fileId: (_c = download.modInfo) === null || _c === void 0 ? void 0 : _c.fileId,
        logicalFileName: download.localPath,
    });
    if (!matchingRule) {
        (0, log_1.log)('debug', 'No matching rule found in collection for download', { downloadId: download.id });
        return null;
    }
...
class InstallManager {
    constructor(api, installPath) {
        ...
        this.mMainInstallsLimit = new ConcurrencyLimiter_1.default(InstallManager.MAX_SIMULTANEOUS_INSTALLS);
        ...
        this.addToPhaseStateCache = (api) => {
            return (download) => {
                var _a;
                const activeCollectionSession = (0, selectors_2.getCollectionActiveSession)(api.getState());
                ...
                const cache = phaseState === null || phaseState === void 0 ? void 0 : phaseState.downloadLookupCache;
                if (cache === undefined) {
                    return;
                }
                if (((_a = download.modInfo) === null || _a === void 0 ? void 0 : _a.referenceTag) !== undefined) {
        ...
        api.events.on('did-finish-download', (downloadId, state) => {
            ...
            if (state === 'finished') {
                ...
                const sourceModId = (_a = context === null || context === void 0 ? void 0 : context.get) === null || _a === void 0 ? void 0 : _a.call(context, 'sourceModId', null);
    ...
    handleDownloadFinished(api, downloadId, sourceModId) {
        var _a, _b, _c, _d, _e;
        ...
        if (hasPhaseState) {
            ...
            if (phaseState) {
                ...
                if ((_a = download.modInfo) === null || _a === void 0 ? void 0 : _a.referenceTag) {
        ...
        const dependency = {
            ...
            download: downloadId,
            phase: ((_b = matchingRule.extra) === null || _b === void 0 ? void 0 : _b.phase) || 0,
            patches: (_d = (_c = matchingRule.extra) === null || _c === void 0 ? void 0 : _c.patches) !== null && _d !== void 0 ? _d : matchingRule.reference.patches,
            installerChoices: matchingRule.installerChoices,
            fileList: (_e = matchingRule.fileList) !== null && _e !== void 0 ? _e : matchingRule.reference.fileList,
        };
    ...
    simulate(api, gameId, archivePath, tempPath, extractList, unattended, installChoices, progress) {
        ...
        return extractProm
            ...
            return installer.install(fileList, tempPath, gameId, (perc) => {
                ...
                progress([], perc);
            }, installChoices, unattended, archivePath, details);
        });
    }
    /**
    ...
    install(archiveId, archivePath, downloadGameIds, api, info, processDependencies, enable, callback, forceGameId, fileList, unattended, forceInstaller, allowAutoDeploy, sourceModId, modReference) {
        ...
        if (archiveId != null) {
            ...
            if (download && download.state !== 'finished') {
                ...
                modReference = modReference || (0, testModReference_1.downloadToModRef)(download);
            }
        }
        const details = {
            modReference,
            ...
            return new Promise((resolve, reject) => {
                ...
                const installationPromise = (0, errorHandling_1.withContext)('Installing', baseName, () => ((forceGameId !== undefined)
                    ...
                    if (games.find(iter => iter.id === installGameId) === undefined) {
                        ...
                        (0, log_1.log)('warn', 'Game extension for download not installed', { installGameId, modId });
                    ...
                    return this.processInstructions(api, installContext, archivePath, tempPath, destinationPath, installGameId, modId, result, fullInfo.choices, unattended, details)
                        .tap(() => {
    ...
    pollAllPhasesComplete(api, sourceModId) {
        ...
        return new bluebird_1.default((resolve) => {
            const poll = () => {
                ...
                const collectionInstallProgress = (0, selectors_2.getCollectionInstallProgress)(api.getState());
                if (!collectionInstallProgress) {
                    const activeCollection = (0, selectors_2.getCollectionActiveSession)(api.getState());
                    if (!activeCollection) {
                        (0, log_1.log)('debug', 'No active collection session, all phases considered complete', { sourceModId });
                ...
                if (collectionInstallProgress === null || collectionInstallProgress === void 0 ? void 0 : collectionInstallProgress.isComplete) {
                    ...
                    const collectionStatus = this.checkCollectionPhaseStatus(api, sourceModId, (_b = phaseState.allowedPhase) !== null && _b !== void 0 ? _b : 0);
                    if (!currentPhaseComplete && (collectionStatus.needsRequeue) && !this.hasActiveOrPendingInstallation(sourceModId)) {
                        ...
                        this.reQueueDownloadedMods(api, sourceModId, collectionStatus.allMods, (_c = phaseState.allowedPhase) !== null && _c !== void 0 ? _c : 0);
                    }
                    if (!hasQueuedDeployments && !this.hasActiveOrPendingInstallation(sourceModId)) {
                        if (phaseState.deployedPhases.has((_d = phaseState.allowedPhase) !== null && _d !== void 0 ? _d : 0)) {
                            // Phase already deployed, maybe advance
                            this.maybeAdvancePhase(sourceModId, api);
                        }
                        else {
                            this.scheduleDeployOnPhaseSettled(api, sourceModId, (_e = phaseState.allowedPhase) !== null && _e !== void 0 ? _e : 0);
                        }
                    }
    ...
    checkCollectionPhaseStatus(api, sourceModId, phase) {
        ...
        const sessionId = (0, util_2.generateCollectionSessionId)(sourceModId, profile === null || profile === void 0 ? void 0 : profile.id);
        const activeCollectionSession = (0, selectors_2.getCollectionSessionById)(state, sessionId);
        ...
        const phaseComplete = (0, selectors_2.isCollectionPhaseComplete)(api.getState(), phase);
        ...
        allDownloadedMods.forEach((mod) => {
            var _a;
            const reference = (_a = mod.rule) === null || _a === void 0 ? void 0 : _a.reference;
            if (!reference) {
                return;
            }
            let downloadId = null;
            if (cache) {
                ...
                downloadId = getReadyDownloadId(downloads, reference, (id) => this.hasActiveOrPendingInstallation(sourceModId, id));
            }
            // If found, check if it's ready and not being installed
            if (downloadId) {
                const download = downloads[downloadId];
                if ((download === null || download === void 0 ? void 0 : download.state) === 'finished' && !this.hasActiveOrPendingInstallation(sourceModId, downloadId) || this.mActiveInstalls.size === 0 && this.mPendingInstalls.size > 0) {
                    modsNeedingRequeue++;
                }
            }
        });
    ...
    reQueueDownloadedMods(api, sourceModId, allMods, currentPhase) {
        ...
        if (anyMarkedSkipped) {
            ...
            phasesToCheck.forEach(checkPhase => {
                const completion = (0, selectors_2.isCollectionPhaseComplete)(api.getState(), checkPhase);
    ...
    scheduleDeployOnPhaseSettled(api, sourceModId, phase, deployOnSettle) {
        ...
        if ((_a = state.deploymentPromises) === null || _a === void 0 ? void 0 : _a.has(phase)) {
            ...
            if (deployOnSettle && !(existing === null || existing === void 0 ? void 0 : existing.deployOnSettle)) {
            ...
            return existing === null || existing === void 0 ? void 0 : existing.deploymentPromise;
        }
        // Track deployment promise so we can wait for it before cleanup
        // Convert Bluebird to native Promise for compatibility
        const deploymentPromise = Promise.resolve(this.pollPhaseSettlement(api, sourceModId, { phase })
            .catch(err => {
    ...
    installInner(api, archivePath, tempPath, destinationPath, gameId, installContext, installationZip, forceInstaller, installChoices, extractList, unattended, details) {
        ...
        return extractProm
            .then((_a) => __awaiter(this, [_a], void 0, function* ({ code, errors }) {
            (0, log_1.log)('debug', 'extraction completed', {
            ...
            if (code !== 0) {
                ...
                yield this.queryContinue(api, errors, archivePath);
            }
        }))
            .catch(ArchiveBrokenError, (err) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ([stagingDirectory_1.STAGING_DIR_TAG, downloadDirectory_1.DOWNLOADS_DIR_TAG].indexOf(path.basename(archivePath)) !== -1) {
                ...
                yield api.showDialog('question', 'Not a mod', {
                ...
                throw new CustomErrors_1.ProcessCanceled('Not a mod');
            }
            // this is really a completely separate process from the "regular" mod installation
            const dialogResult = yield api.showDialog('question', 'Not an archive', {
            ...
            yield (0, walk_1.default)(tempPath, (0, bluebird_1.method)((iterPath, stats) => __awaiter(this, void 0, void 0, function* () {
                if (stats.isFile()) {
                    fileList.push(path.relative(tempPath, iterPath));
                }
                else {
            ...
            const allowList = (0, cSharpScriptAllowList_1.getCSharpScriptAllowListForGame)(gameId);
            if (hasCSScripts && !allowList.has(((_b = (_a = details === null || details === void 0 ? void 0 : details.modReference) === null || _a === void 0 ? void 0 : _a.repo) === null || _b === void 0 ? void 0 : _b.modId) || '')) {
                const modName = ((_c = details === null || details === void 0 ? void 0 : details.modReference) === null || _c === void 0 ? void 0 : _c.id) || path.basename(archivePath, path.extname(archivePath));
                ...
                const dialogResult = yield ((_d = api.showDialog) === null || _d === void 0 ? void 0 : _d.call(api, 'question', t(`Unsafe Mod Detected`), {
                    bbcode: t(`"{{modName}}" contains C# scripts that can run code on your computer.[br][/br][br][/br]` +
                        ...
                        `Are you sure you want to continue?`, { replace: { modName: modName } }),
                }, [{ label: no }, { label: yes }, /*{ label: yesForAll }*/]));
                switch (dialogResult === null || dialogResult === void 0 ? void 0 : dialogResult.action) {
                    case no:
                        throw new CustomErrors_1.ProcessCanceled('User declined to install mod with C# scripts');
            ...
            if ((0, util_1.truthy)(extractList) && extractList.length > 0) {
                const supportedInstaller = yield (0, listInstaller_1.default)(extractList, tempPath);
                return Object.assign(Object.assign({}, supportedInstaller), testDetails);
            }
            else if (forceInstaller === undefined) {
                const supportedInstaller = yield this.getInstaller(fileList, gameId, archivePath, undefined, testDetails);
                return Object.assign(Object.assign({}, supportedInstaller), testDetails);
            }
            else {
                const forced = this.mInstallers.find(inst => inst.id === forceInstaller);
                const testResult = yield forced.testSupported(fileList, gameId, archivePath, testDetails);
                if (!testResult.supported) {
                    return undefined;
                }
                else {
                    return Object.assign({ installer: forced, requiredFiles: testResult.requiredFiles }, testDetails);
                }
            }
        }))
            ...
            const innerDetails = {
                ...
                hasCSScripts: supportedInstaller === null || supportedInstaller === void 0 ? void 0 : supportedInstaller.hasCSScripts,
                hasXmlConfigXML: supportedInstaller === null || supportedInstaller === void 0 ? void 0 : supportedInstaller.hasXmlConfigXML,
            };
    ...
    processSubmodule(api, installContext, submodule, destinationPath, gameId, modId, choices, unattended, details) {
        return bluebird_1.default.each(submodule, mod => {
            ...
            return this.installInner(api, mod.path, tempPath, destinationPath, gameId, subContext, submoduleZip, undefined, choices, undefined, unattended, details)
                .then((resultInner) => this.processInstructions(api, installContext, mod.path, tempPath, destinationPath, gameId, modId, resultInner, choices, unattended, details))
                .then(() => {
    ...
    processInstructions(api, installContext, archivePath, tempPath, destinationPath, gameId, modId, result, choices, unattended, details) {
        var _a, _b;
        ...
        return this.processMKDir(instructionGroups.mkdir, destinationPath)
            ...
            .then(() => this.processSubmodule(api, installContext, instructionGroups.submodule, destinationPath, gameId, modId, choices, unattended, details))
    ...
    getInstaller(fileList, gameId, archivePath, offsetIn, details) {
        const offset = offsetIn || 0;
        if (offset >= this.mInstallers.length) {
            return bluebird_1.default.resolve(undefined);
        }
        return bluebird_1.default.resolve(this.mInstallers[offset].testSupported(fileList, gameId, archivePath, details))
            .then((testResult) => {
        ...
        if (dependencies.length > 0) {
            ...
            if (activeCollectionSession) {
                ...
                Array.from(allPhases).sort((a, b) => a - b).forEach(phase => {
                    const isPhaseComplete = (0, selectors_2.isCollectionPhaseComplete)(api.getState(), phase);
                    if (isPhaseComplete) {
    ...
    installDependenciesImpl(api, profile, gameId, modId, name, rules, installPath, silent) {
        ...
        return (0, dependencies_1.default)(filteredRules, api, false, progress, this.addToPhaseStateCache(api))
            .then((dependencies) => {
    ...
    installRecommendationsImpl(api, profile, gameId, modId, name, rules, installPath, silent) {
        ...
        api.store.dispatch((0, actions_1.startActivity)('dependencies', 'gathering'));
        return (0, dependencies_1.default)(filteredRules, api, true, undefined, this.addToPhaseStateCache(api))
            .then((dependencies) => {
            api.store.dispatch((0, actions_1.stopActivity)('dependencies', 'gathering'));
            if (dependencies.length === 0) {
                return bluebird_1.default.resolve();
    ...
    extractArchive(api, archivePath, tempPath, destinationPath, copies, gameId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const copyAsyncWrap = (src, dst) => __awaiter(this, void 0, void 0, function* () {
                try {
                    yield fs.copyAsync(src, dst);
                }
                catch (err) {
                    if (err instanceof CustomErrors_1.SelfCopyCheckError) {
            ...
            try {
                ...
                yield bluebird_1.default.map(jobs, (job) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        if ((err === null || err === void 0 ? void 0 : err.code) && ['EXDEV', 'EPERM', 'EACCES', 'ENOTSUP', 'EEXIST'].includes(err.code)) {
                            yield copyAsyncWrap(job.src, job.dst);
                        }
                        else {
                            throw err;
                        }
        ...
        if (reference === null || reference === void 0 ? void 0 : reference.repo) {
            ...
            if (modId && fileId) {
                const altDownloadId = Object.keys(relevantDownloads).find(dlId => {
                    ...
                    const download = relevantDownloads[dlId];
                    return ((_d = (_c = (_b = (_a = download.modInfo) === null || _a === void 0 ? void 0 : _a.nexus) === null || _b === void 0 ? void 0 : _b.ids) === null || _c === void 0 ? void 0 : _c.modId) === null || _d === void 0 ? void 0 : _d.toString()) === modId.toString() &&
                        ((_h = (_g = (_f = (_e = download.modInfo) === null || _e === void 0 ? void 0 : _e.nexus) === null || _f === void 0 ? void 0 : _f.ids) === null || _g === void 0 ? void 0 : _g.fileId) === null || _h === void 0 ? void 0 : _h.toString()) === fileId.toString() &&
                        download.state === 'finished';
                });
                if (altDownloadId) {
                    return altDownloadId;
...
InstallManager.MAX_SIMULTANEOUS_INSTALLS = 5;
