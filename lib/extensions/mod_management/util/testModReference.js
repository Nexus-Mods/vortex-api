...
exports.modAttributesToLookupInfo = modAttributesToLookupInfo;
...
function modAttributesToLookupInfo(mod) {
    ...
    const gameAttrib = mod.game;
    if (gameAttrib && Array.isArray(gameAttrib) && gameAttrib.length > 0) {
        return mod;
    }
    const attrs = (_a = mod.attributes) !== null && _a !== void 0 ? _a : mod;
    return {
        id: mod.id,
        fileMD5: attrs.fileMD5,
        fileSizeBytes: (_b = attrs.fileSize) !== null && _b !== void 0 ? _b : 0,
        fileName: (_d = (_c = attrs.fileName) !== null && _c !== void 0 ? _c : attrs.modName) !== null && _d !== void 0 ? _d : attrs.name,
        name: (_e = attrs.modName) !== null && _e !== void 0 ? _e : attrs.name,
        ...
        version: (_g = (_f = attrs.version) !== null && _f !== void 0 ? _f : attrs.modVersion) !== null && _g !== void 0 ? _g : "",
        game: attrs.game,
        fileId: (_h = attrs.fileId) === null || _h === void 0 ? void 0 : _h.toString(),
        modId: (_j = attrs.modId) === null || _j === void 0 ? void 0 : _j.toString(),
        source: attrs.source,
...
function safeCoerce(input) {
    var _a;
    return coerceableRE.test(input) ? ((_a = coerceToSemver(input)) !== null && _a !== void 0 ? _a : input) : input;
}
...
function hasIdentifyingMarker(mod, modId, ref, fuzzyVersion, allowTag) {
    ...
    return ((ref.id !== undefined && modId !== undefined) ||
        ...
        (ref.fileExpression !== undefined &&
            ((_a = mod.fileName) !== null && _a !== void 0 ? _a : mod.name) !== undefined) ||
...
function testRef(mod, modId, ref, source, fuzzyVersion) {
    ...
    if (refHasPatches) {
        ...
        if ((mod === null || mod === void 0 ? void 0 : mod.referenceTag) !== (ref === null || ref === void 0 ? void 0 : ref.tag)) {
            return false;
        }
    }
    if (ref.tag != null) {
    ...
    if ((0, util_1.truthy)(ref.fileMD5) && !fuzzyVersion && mod.fileMD5 !== ref.fileMD5) {
        return false;
    }
    if (ref.repo != null) {
    ...
    if (ref.logicalFileName != null) {
        ...
        else if (![mod.logicalFileName, mod.customFileName].includes(ref.logicalFileName) &&
            ref.fileExpression == null) {
            return false;
        }
    }
    ...
    if ((0, util_1.truthy)(ref.versionMatch) &&
        ...
        if (!doesMatch) {
            ...
            if (semver.valid(versionCoerced)) {
                if (!semver.satisfies(versionCoerced, versionMatch, {
                    loose: true,
...
function testRefByIdentifiers(identifiers, ref) {
    ...
    if (((_a = ref.repo) === null || _a === void 0 ? void 0 : _a.modId) != null &&
        modId != null &&
        ((_b = ref.repo) === null || _b === void 0 ? void 0 : _b.fileId) != null &&
        fileIds != null &&
        fileIds.length > 0) {
