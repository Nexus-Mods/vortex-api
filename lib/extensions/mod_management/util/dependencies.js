    ...
    try {
        ...
        const existing = Object.keys(downloads).filter((dlId) => {
            ...
            const identifiers = {
                ...
                name: (lookup === null || lookup === void 0 ? void 0 : lookup.logicalFileName) || ((_a = download.modInfo) === null || _a === void 0 ? void 0 : _a.name),
                gameId: download.game[0],
            };
            return (_b = (0, testModReference_1.default)(lookup, reference, undefined, fuzzy)) !== null && _b !== void 0 ? _b : (0, testModReference_1.testRefByIdentifiers)(identifiers, reference);
        })
