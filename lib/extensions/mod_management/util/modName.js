...
function modNameFromAttributes(mod, options) {
    const fields = [];
    fields.push(storeHelper_1.getSafe(mod, ['customFileName'], storeHelper_1.getSafe(mod, ['logicalFileName'], storeHelper_1.getSafe(mod, ['fileName'], storeHelper_1.getSafe(mod, ['name'], '')))));
