export declare type AppPath = 'base' | 'assets' | 'assets_unpacked' | 'modules' | 'modules_unpacked' | 'bundledPlugins' | 'locales' | 'package' | 'application' | 'userData' | 'appData' | 'localAppData' | 'temp' | 'home' | 'documents';
/**
