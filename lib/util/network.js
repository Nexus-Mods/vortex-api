...
function rawRequest(apiURL, options) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const get = parsed.protocol === "http:" ? http_1.get : https_1.get;
        get({
            ...
            let rawData = options.encoding !== undefined ? "" : Buffer.alloc(0);
            res.on("data", (chunk) => {
                if (options.encoding !== undefined) {
                    rawData += chunk;
                }
...
function request(method, reqURL, headers, cb) {
    ...
    const reqFunc = parsed.protocol === "http:" ? http_1.request : https_1.request;
...
function upload(targetUrl, dataStream, dataSize) {
    return new Promise((resolve, reject) => {
        ...
        const req = request("PUT", targetUrl, {
            ...
            const { statusCode } = res;
            (0, log_1.log)("debug", "upload complete", {
                targetUrl,
                dataSize,
                statusCode,
