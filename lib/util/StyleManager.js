        ...
        if (requested) {
            try {
                ...
                if (_.isEqual(cache.stylesheets, stylesheets)) {
                    ...
                    (0, log_1.log)("debug", "using cached css", {
...
class StyleManager {
    ...
    clearCache() {
        this.mSetQueue = this.mSetQueue.then(() => fs
        ...
        try {
            ...
            this.mSetQueue = this.mSetQueue
                ...
                if (idx !== -1) {
                    ...
                    this.mPartials.splice(this.mPartials.length - 2, 0, {
                        key,
                        file: filePath,
                    });
                }
            ...
            (0, log_1.log)("warn", "stylesheet can't be read", {
                key,
                path: filePath,
                err: err.message,
            });
