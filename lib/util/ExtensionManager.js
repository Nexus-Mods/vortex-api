...
class ContextProxyHandler {
    constructor(context) {
        ...
        this.findExt = (id, allExtensions) => {
            return allExtensions.find((ext) => { var _a, _b; return ((_a = ext.info) === null || _a === void 0 ? void 0 : _a.name) === id || ((_b = ext.info) === null || _b === void 0 ? void 0 : _b.id) === id || ext.name === id; });
        };
    ...
    unloadIncompatible(furtherAPIs, allExtensions) {
        ...
        this.mInitCalls
            .filter((call) => !call.optional && !fullAPI.has(call.key))
            .forEach((call) => {
            (0, log_1.log)("debug", "unsupported api call", {
                extension: call.extension,
                api: call.key,
            });
            (0, util_1.setdefault)(incompatibleExtensions, call.extension, []).push({
                id: "unsupported-api",
            });
        });
        const testValid = (extId, requiredId, version, optional) => {
            ...
            if (!optional) {
                ...
                if (req === undefined) {
                    (0, util_1.setdefault)(incompatibleExtensions, extId, []).push({
                        id: "dependency",
                        args: { dependencyId: requiredId },
                    });
                }
                else if (version !== undefined &&
                    !semver.satisfies((_a = req.info) === null || _a === void 0 ? void 0 : _a.version, version)) {
                    (0, util_1.setdefault)(incompatibleExtensions, extId, []).push({
                        id: "dependency",
        ...
        this.getCalls("requireVersion").forEach((call) => {
            if (process.env.NODE_ENV !== "development" &&
                !semver.satisfies((0, application_1.getApplication)().version, call.arguments[0], {
        ...
        if (Object.keys(incompatibleExtensions).length > 0) {
            (0, log_1.log)("info", "extensions ignored for using unsupported api", {
...
class ExtensionManager {
    ...
    constructor(initStore, eventEmitter) {
        ...
        this.stateChangeHandler = (watchPath, callback, ext) => {
            if (!(0, util_1.isFunction)(callback)) {
                ...
                (0, log_1.log)("error", "attempt to register invalid change handler", {
        ...
        this.lookupModMeta = (detail, ignoreCache) => {
            ...
            if (fileMD5 === undefined) {
                promise = this.genMd5Hash(detail.filePath)
                    ...
                    .catch((err) => {
                    (0, log_1.log)("info", "failed to calculate hash", {
        ...
        this.genMd5Hash = (data, progressFunc) => {
            ...
            return (0, util_1.toPromise)((cb) => (0, vortexmt_1.fileMD5)(data, cb, progressHash)).then((result) => {
                if (lastProgress === 0) {
        ...
        this.openArchive = (archivePath, options, ext) => {
            ...
            return creator(archivePath, options || {}).then((handler) => bluebird_1.default.resolve(new archives_1.Archive(handler)));
        };
            ...
            return (this.applyStartHooks({ executable, args, options })
                ...
                try {
                    const runParams = {
                        executable,
                        args,
                        options: Object.assign(Object.assign({}, options), { env }),
                    };
                    ...
                    const child = (0, child_process_1.spawn)(runExe, options.shell
                        ? args
                        : args.map((arg) => arg.replace(/"/g, "")), spawnOptions);
        ...
        this.withPrePost = (eventName, cb) => {
            return (...args) => {
                return this.emitAndAwait(`will-${eventName}`, ...args)
                    .then(() => cb(...args))
                    .then((res) => this.emitAndAwait(`did-${eventName}`, res, ...args).then(() => res));
            };
        };
        ...
        this.mApi = {
            ...
            translate: (input, options) => {
                ...
                if (options === null || options === void 0 ? void 0 : options.isNamespaceKey) {
                    return this.mTranslator.t(input, Object.assign(Object.assign({}, options), { keySeparator: ".", nsSeparator: ":" }));
                }
        ...
        if (initStore !== undefined) {
            ...
            try {
                const disableExtensions = fs
                    .readdirSync((0, getVortexPath_1.default)("temp"))
                    .filter((name) => name.startsWith("__disable_"));
                disableExtensions.forEach((ext) => {
                    const extId = ext.substr(10);
                    (0, log_1.log)("info", "disabling extension that caused a crash before", {
                        extId,
                    });
        ...
        if (this.mOutdated.length > 0) {
            this.mOutdated.forEach((ext) => {
                var _a;
                (0, log_1.log)("info", "extension older than bundled version, will be removed", {
                    name: ext,
                });
    ...
    setStore(store) {
        ...
        this.mApi.sendNotification = (notification) => {
            ...
            if (this.canBeToast(noti)) {
                try {
                    const toastFunc = noti.type === "error" ? react_hot_toast_1.toast.error : react_hot_toast_1.toast.success;
                    const toastOptions = {
                        id: noti.id,
                        duration: noti.displayMS,
                    };
                    const message = noti.title !== undefined
                        ? `${noti.title}:\n${(_a = noti.message) !== null && _a !== void 0 ? _a : ""}`
                        : ((_b = noti.message) !== null && _b !== void 0 ? _b : "");
                    if (message.length > 0) {
                    ...
                    (0, log_1.log)("warn", "Failed to show toast notification", err.message);
                }
            }
            if (notification.type === "warning") {
                (0, log_1.log)("warn", "warning notification", {
                    message: notification.message,
                    title: notification.title,
                });
            }
            else if (notification.type === "error") {
                (0, log_1.log)("warn", "error notification", {
                    message: notification.message,
                    title: notification.title,
                });
            }
        ...
        this.mApi.showErrorNotification = function (message, details, options) {
            ...
            if (extension === undefined && (details === null || details === void 0 ? void 0 : details["extension"]) !== undefined) {
                extension = this.getLoadedExtensions().find((iter) => iter.name === details["extension"]);
            }
            if (extension !== undefined &&
                ...
                if (options.allowReport !== false) {
                    ...
                    const remoteExtensions = this.getState().session
    ...
    reportExtLoadErrors() {
        ...
        const nodeLoadErr = Object.values(this.mLoadFailures)
            ...
            return (msg.includes("The specified module could not be found.") &&
                msg.includes(".node"));
        });
    ...
    setupApiMain(store, ipc) {
        this.mApi.showErrorNotification = (message, details, options) => {
            try {
                ...
                // reconstructed.
                const data = typeof details === "object" ? Object.assign({}, details) : details;
    ...
    doOnce() {
        ...
        const reportError = (err, call, allowReport = true) => {
            (0, log_1.log)("warn", "failed to call once", {
                err: err.message,
                stack: err.stack,
            });
        ...
        return bluebird_1.default.mapSeries(calls, (call, idx) => {
            ...
            try {
                ...
                return (0, util_1.timeout)(prom, 60000, {
                    ...
                    if (elapsed > 1000) {
                        (0, log_1.log)("debug", "slow initialization", {
                            extension: call.extension,
                            elapsed,
                        });
                    }
    ...
    connectMetaDB(gameId, apiKey) {
        ...
        return modmeta.ModDB.create(dbPath, gameId, this.getMetaServerList(), log_1.log).catch((err) => {
            return this.mApi
                .showDialog("error", "Failed to connect meta database", {
    ...
    initExtensions() {
        ...
        this.mExtensions.forEach((ext) => {
            ...
            try {
                ...
                (0, log_1.log)("warn", "couldn't initialize extension", {
                    name: ext.name,
                    err: err.message,
                    stack: err.stack,
                });
        ...
        this.mExtensions
            ...
            try {
                ...
                if (!semver.valid(oldVersion)) {
                    (0, log_1.log)("error", "invalid version stored for extension", {
                        extension: ext.name,
                        oldVersion,
                    });
                    oldVersion = "0.0.0";
                ...
                if (oldVersion !== ext.info.version) {
                    if (migrations[ext.name] === undefined) {
                        ...
                        bluebird_1.default.mapSeries(migrations[ext.name], (mig) => mig(oldVersion))
                            .then(() => {
                            (0, log_1.log)("info", "set extension version", {
                                name: ext.name,
    ...
    selectFile(options) {
        ...
        return bluebird_1.default.resolve(showOpenDialog(fullOptions)).then((result) => result.filePaths !== undefined && result.filePaths.length > 0
            ? result.filePaths[0]
            : undefined);
    }
    saveFile(options) {
        ...
        //}
        return bluebird_1.default.resolve(showSaveDialog(fullOptions)).then((result) => result.filePath !== undefined ? result.filePath : undefined);
    }
    ...
    applyStartHooks(input) {
        let updated = input;
        return bluebird_1.default.each(this.mStartHooks, (hook) => hook
            .hook(updated)
            .then((newParameters) => {
    ...
    runElevated(executable, cwd, args, env, onSpawned) {
        ...
        return new bluebird_1.default((resolve, reject) => {
            ...
            winapi
                .runElevated(ipcPath, runElevatedCustomTool_1.default, {
                toolPath: executable,
                toolCWD: cwd,
                parameters: args,
                environment: env,
    ...
    loadDynamicExtension(extensionPath, alreadyLoaded, bundled) {
        ...
        if (indexPath !== undefined) {
            ...
            const namespace = (_b = (_a = info.namespace) !== null && _a !== void 0 ? _a : info.id) !== null && _b !== void 0 ? _b : (bundled ? pathName : this.idify(info.name, pathName));
            ...
            (0, log_1.log)("debug", "extension directory contains no index.js file", {
                extensionPath,
            });
            return undefined;
        }
    ...
    loadDynamicExtensions(extension, loadedExtensions, alreadyLoaded) {
        if (!fs.existsSync(extension.path)) {
            ...
            try {
                ...
                (0, log_1.log)("warn", "extension path missing and can't be created", {
                    path: extension.path,
                    error: err.message,
                });
            }
        ...
        const res = fs
            ...
            try {
                ...
                if (ext !== undefined) {
                    ...
                    (0, log_1.log)("debug", "loaded extension", {
                        name,
                        loadTime,
                    ...
                    if (prev[ext.name] !== undefined) {
                        ...
                        (0, log_1.log)("warn", "multiple copies of the same extension installed", {
                            first: ext.path,
                ...
                (0, log_1.log)("warn", "failed to load dynamic extension", {
                    name,
                    error: err.message,
                    stack: err.stack,
                });
