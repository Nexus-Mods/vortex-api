...
class GitHub {
    ...
    query(baseUrl, request) {
        if (this.mRatelimitReset !== undefined &&
        ...
        return new bluebird_1.default((resolve, reject) => {
            ...
            https
                ...
                if (res.statusCode === 403 && callsRemaining === 0) {
                    ...
                    (0, log_1.log)("info", "GitHub rate limit exceeded", {
