...
declare const removeAsync: typeof fs.removeAsync;
...
export { chmodAsync, closeAsync, fsyncAsync, linkAsync, lstatAsync, mkdirAsync, mkdirsAsync, moveAsync, openAsync, readlinkAsync, readdirAsync, readFileAsync, removeAsync, statAsync, symlinkAsync, utimesAsync, writeAsync, writeFileAsync, isDirectoryAsync, };
