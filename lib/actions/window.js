 ...
 */
exports.setWindowSize = safeCreateAction_1.default('STORE_WINDOW_SIZE');
/**
 * action to set window position in the store.
 * Takes one parameter of the form {x: number, y: number}
 */
exports.setWindowPosition = safeCreateAction_1.default('STORE_WINDOW_POSITION');
/**
 ...
 */
exports.setMaximized = safeCreateAction_1.default('SET_MAXIMIZED');
exports.setTabsMinimized = safeCreateAction_1.default('SET_TABS_MINIMIZED');
exports.setCustomTitlebar = safeCreateAction_1.default('SET_CUSTOM_TITLEBAR');
