...
exports.dismissDialog = exports.addDialog = exports.stopAllNotifications = exports.stopNotification = exports.updateNotification = exports.startNotification = void 0;
...
exports.updateNotification = (0, safeCreateAction_1.default)("UPDATE_NOTIFICATION", (id, progress, message) => ({
    id,
    progress,
    message,
...
exports.stopAllNotifications = (0, safeCreateAction_1.default)("STOP_ALL_NOTIFICATIONS");
/**
...
function dismissAllNotifications() {
    return (dispatch) => new bluebird_1.default((resolve, reject) => {
        const ids = Array.from(new Set([].concat(Object.keys(timers), Object.keys(notificationActions))));
        ids.forEach((id) => {
            delete timers[id];
            delete notificationActions[id];
        });
        dispatch((0, exports.stopAllNotifications)());
        resolve();
    });
}
...
function closeDialogs(ids, actionKey, input) {
    return (dispatch) => {
        for (const id of ids) {
            dispatch((0, exports.dismissDialog)(id));
            try {
