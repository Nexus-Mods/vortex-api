...
exports.removeExtension = safeCreateAction_1.default('REMOVE_EXTENSION');
exports.forgetExtension = safeCreateAction_1.default('FORGET_EXTENSION');
exports.setInstanceId = safeCreateAction_1.default('SET_INSTANCE_ID');
