...
export declare function safeCreateAction<Arg1, Arg2, P, M = {}>(description: string, payloadReducer: ra.PayloadReducer2<Arg1, Arg2, P>, metaReducer?: ra.MetaReducer<M>): ra.ComplexActionCreator2<Arg1, Arg2, P, M>;
export declare function safeCreateAction<Arg1, Arg2, Arg3, P, M = {}>(description: string, payloadReducer: ra.PayloadReducer3<Arg1, Arg2, Arg3, P>, metaReducer?: ra.MetaReducer<M>): ra.ComplexActionCreator3<Arg1, Arg2, Arg3, P, M>;
