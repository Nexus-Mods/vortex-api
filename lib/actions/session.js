...
exports.setOpenMainPage = safeCreateAction_1.default('SET_OPEN_MAINPAGE', (page, secondary) => ({ page, secondary: secondary || false }));
...
exports.setExtensionLoadFailures = safeCreateAction_1.default('SET_EXT_LOAD_FAILURES');
