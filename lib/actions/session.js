...
exports.setProgress = (0, safeCreateAction_1.default)("SET_PROGRESS", (group, progressId, text, percent) => ({
    group,
    progressId,
    text,
    percent,
}));
exports.setToolRunning = (0, safeCreateAction_1.default)("SET_TOOL_RUNNING", (exePath, started, exclusive) => ({
    exePath,
    started,
    exclusive,
}));
exports.setToolPid = (0, safeCreateAction_1.default)("SET_TOOL_RUNNING", (exePath, pid, exclusive) => ({
    exePath,
    pid,
    exclusive,
}));
...
exports.setUIBlocker = (0, safeCreateAction_1.default)("SET_UI_BLOCKER", (id, icon, description, mayCancel) => ({
    id,
    icon,
    description,
    mayCancel,
