...
class QuickLauncher extends ComponentEx_1.ComponentEx {
    constructor(props) {
        ...
        this.renderGameOption = (gameId) => {
            ...
            let displayName = (0, storeHelper_1.getSafe)(discovered, ["shortName"], (0, storeHelper_1.getSafe)(game, ["shortName"], undefined)) || (0, storeHelper_1.getSafe)(discovered, ["name"], (0, storeHelper_1.getSafe)(game, ["name"], undefined));
            ...
            return (React.createElement("div", { className: "tool-icon-container", style: { background: `url('${iconPath}')` } },
                React.createElement("div", { className: "quicklaunch-item" },
                    ...
                    profilesVisible ? (React.createElement("div", { className: "quicklaunch-profile" },
                        t("Profile"),
    ...
    makeStarter(props) {
        ...
        try {
            ...
            (0, log_1.log)("error", "failed to create quick launcher entry", {
                error: err.message,
                stack: err.stack,
            });
            return undefined;
...
function mapStateToProps(state) {
    ...
    return {
        ...
        discoveredTools: (0, storeHelper_1.getSafe)(state, ["settings", "gameMode", "discovered", gameMode, "tools"], {}),
