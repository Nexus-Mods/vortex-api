...
class MainWindow extends React.Component {
        ...
        this.renderPageGroup = ({ title, key, }) => {
            ...
            const pages = objects.filter((page) => {
                try {
                    ...
                    (0, log_1.log)("error", "Failed to determine page visibility", {
                        error: err.message,
                        page: page.id,
                    });
                    return false;
    ...
    renderWait() {
        ...
        const control = progress !== undefined ? (React.createElement(ProgressBar_1.default, { labelLeft: progress.text, now: progress.percent, style: { width: "50%" } })) : (React.createElement(Spinner_1.default, { style: { width: 64, height: 64 } }));
        return (React.createElement("div", { key: "wait" },
            React.createElement("div", { className: "center-content", style: { flexDirection: "column" } },
                React.createElement("h4", null, t("Switching to Profile: {{name}}", {
                    replace: { name: (_a = profile === null || profile === void 0 ? void 0 : profile.name) !== null && _a !== void 0 ? _a : t("None") },
                })),
                control),
            React.createElement(Dialog_1.default, null),
            React.createElement(DialogContainer_1.default, { visibleDialog: visibleDialog, onHideDialog: onHideDialog })));
    ...
    renderBlocker(id, blocker) {
        ...
        return (React.createElement("div", { className: "ui-blocker" },
            ...
            blocker.mayCancel ? (React.createElement(react_bootstrap_1.Button, { "data-id": id, onClick: this.unblock }, t("Cancel"))) : null));
    }
    updateState(spec) {
        ...
        return (React.createElement(FlexLayout_1.default.Flex, null,
            React.createElement(FlexLayout_1.default, { type: "row", style: { overflow: "hidden" } },
                ...
                React.createElement(FlexLayout_1.default.Flex, { fill: true, id: "main-window-pane" },
                    React.createElement(DNDContainer_1.default, { style: {
                            display: "flex",
