...
class Notification extends ComponentEx_1.ComponentEx {
    ...
    render() {
        ...
        return (React.createElement("div", { role: "alert", className: `notification alert-${styleName}` },
            progress !== undefined ? (React.createElement("span", { className: "notification-progress", style: { left: `${progress}%` } })) : null,
    ...
    typeToIcon(type) {
        switch (type) {
            ...
            case "success":
                return React.createElement(Icon_1.default, { name: "feedback-success" });
            case "info":
                return React.createElement(Icon_1.default, { name: "feedback-info" });
            case "warning":
                return React.createElement(Icon_1.default, { name: "feedback-warning" });
            case "error":
                return React.createElement(Icon_1.default, { name: "feedback-error" });
            default:
                return null;
        }
    }
