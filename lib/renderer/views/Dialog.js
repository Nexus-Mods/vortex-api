...
const bbcode_1 = __importDefault(require("../controls/bbcode"));
const ComponentEx_1 = require("../controls/ComponentEx");
...
class Dialog extends ComponentEx_1.ComponentEx {
    constructor(props) {
            ...
            if (!evt.defaultPrevented) {
                ...
                if (evt.key === "Enter") {
                    if (dialog.defaultAction !== undefined) {
                        evt.preventDefault();
                        const filterFunc = (res) => res.actions.find((act) => act === dialog.defaultAction) !==
                            undefined;
        ...
        this.renderInput = (input, idx) => {
            ...
            const validationState = valRes !== undefined ? (valRes.length !== 0 ? "error" : "success") : null;
            ...
            return (React.createElement(react_bootstrap_1.FormGroup, { key: input.id, validationState: validationState },
                ...
                valRes !== undefined && valRes.length !== 0 ? (React.createElement("label", { className: "control-label" }, valRes.map((res) => res.errorText).join("\n"))) : null));
        };
        ...
        this.renderCheckbox = (checkbox, content) => {
            var _a, _b, _c, _d;
            const { t } = this.props;
            const translated = ((_a = content.options) === null || _a === void 0 ? void 0 : _a.translated) !== false;
            const text = checkbox.bbcode !== undefined
                ? (0, bbcode_1.default)(translated
                    ? t(checkbox.bbcode, {
                        replace: content.parameters,
                        count: (_b = content.parameters) === null || _b === void 0 ? void 0 : _b.count,
                    })
                    : checkbox.bbcode, (_c = content.options) === null || _c === void 0 ? void 0 : _c.bbcodeContext)
                : translated
                    ? t(checkbox.text, {
                        replace: content.parameters,
                        count: (_d = content.parameters) === null || _d === void 0 ? void 0 : _d.count,
                    })
                    : checkbox.text;
        ...
        this.renderRadiobutton = (checkbox) => {
            const { t } = this.props;
            const content = (React.createElement("div", null, checkbox.subText !== undefined ? (React.createElement(React.Fragment, null,
                React.createElement("div", { className: "choice-maintext" }, t(checkbox.text)),
                React.createElement("div", { className: "choice-subtext" }, t(checkbox.subText)))) : (React.createElement("div", { className: "choice-text" }, t(checkbox.text)))));
        ...
        this.enableMultiple = (enabled = true) => {
            const { dialogState } = this.state;
            const newCheckboxes = JSON.parse(JSON.stringify(dialogState.checkboxes.slice(0))).map((box) => (Object.assign(Object.assign({}, box), { value: enabled })));
            let newState = (0, immutability_helper_1.default)(this.state, {
                dialogState: {
                    checkboxes: { $set: newCheckboxes },
                },
    ...
    render() {
        ...
        const type = dialog.content.htmlFile !== undefined ||
                ...
                React.createElement(react_bootstrap_1.Modal.Header, null,
                    React.createElement(react_bootstrap_1.Modal.Title, null,
                        ...
                        t(dialog.title, {
                            ...
                            count: (_a = dialog.content.parameters) === null || _a === void 0 ? void 0 : _a.count,
                        }))),
    ...
    renderContent(content) {
        ...
        if (content.text) {
            controls.push({
                id: "text",
                control: (React.createElement("div", { key: "dialog-content-text", className: "dialog-content-text" }, t(content.text, {
                    replace: content.parameters,
                    count: (_b = content.parameters) === null || _b === void 0 ? void 0 : _b.count,
                }))),
            });
        ...
        if (content.bbcode !== undefined) {
            ...
            controls.push({
                id: "bbcode",
                control: (React.createElement("div", { key: "dialog-content-bbcode", className: "dialog-content-bbcode" }, (0, bbcode_1.default)(bbcodeContent, (_c = content.options) === null || _c === void 0 ? void 0 : _c.bbcodeContext))),
            });
        }
        if (content.md !== undefined) {
            controls.push({
                id: "md",
                control: (React.createElement("div", { key: "dialog-content-markdown", className: "dialog-content-markdown" },
                    React.createElement(react_markdown_1.default, null, t(content.md, {
                        replace: content.parameters,
                        count: (_d = content.parameters) === null || _d === void 0 ? void 0 : _d.count,
                    })))),
            });
        ...
        if (content.message !== undefined) {
            ...
            if (content.options !== undefined &&
                ...
                controls.push({
                    id: "message",
                    control: (React.createElement(Collapse_1.default, { key: "dialog-content-message-wrapper", showText: t("Show Details"), hideText: t("Hide Details") }, ctrl)),
                });
            }
            else {
        ...
        if (content.htmlFile !== undefined) {
            controls.push({
                id: "htmlFile",
                control: (React.createElement("div", { key: "dialog-content-html-file" },
        ...
        if (content.htmlText !== undefined) {
            controls.push({
                id: "htmlText",
                control: (React.createElement("div", { key: "dialog-content-html-text", className: "dialog-content-html", dangerouslySetInnerHTML: { __html: content.htmlText } })),
            });
        }
        if (content.input !== undefined) {
            controls.push({
                id: "input",
                control: (React.createElement("div", { key: "dialog-form-content", className: "dialog-content-input" }, content.input.map(this.renderInput))),
            });
        }
        if (content.checkboxes !== undefined) {
            controls.push({
                id: "checkboxes",
                control: (React.createElement("div", { key: "dialog-content-checkboxes", className: "dialog-content-choices" },
        ...
        if (content.choices !== undefined) {
            controls.push({
                id: "choices",
                control: (React.createElement("div", { key: "dialog-content-choices", className: "dialog-content-choices" },
        ...
        if (content.links !== undefined) {
            controls.push({
                id: "links",
                control: (React.createElement("div", { key: "dialog-form-links" }, content.links.map(((_e = content.options) === null || _e === void 0 ? void 0 : _e.linksAsButtons)
                    ? this.renderButton
                    : this.renderLink))),
            });
        }
        if (((_f = content.options) === null || _f === void 0 ? void 0 : _f.order) !== undefined) {
    ...
    iconForType(type) {
        switch (type) {
            case "info":
                return React.createElement(Icon_1.default, { name: "dialog-info", className: "icon-info" });
            case "error":
                return React.createElement(Icon_1.default, { name: "dialog-error", className: "icon-error" });
            case "question":
                return React.createElement(Icon_1.default, { name: "dialog-question", className: "icon-question" });
            default:
                return null;
        }
    }
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        onDismissMultiple: (ids, action, input) => dispatch((0, notifications_1.closeDialogs)(ids, action, input)),
    };
}
