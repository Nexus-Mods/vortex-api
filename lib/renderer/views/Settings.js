...
class Settings extends ComponentEx_1.ComponentEx {
    constructor(props) {
        ...
        this.renderTab = (page) => {
            ...
            const content = elements.length > 0 ? (React.createElement("div", null, elements.map(this.renderTabElement))) : (React.createElement(EmptyPlaceholder_1.default, { icon: "settings", text: t("Nothing to configure."), subtext: t("Other games may require settings here.") }));
    ...
    render() {
        ...
        const combined = objects.reduce((prev, current) => {
            ...
            if (existingPage === undefined) {
                ...
                if (existingPage.priority === undefined ||
