...
const ComponentEx_1 = require("../ComponentEx");
...
class DetailCell extends React.Component {
    ...
    render() {
        ...
        if (attribute.customRenderer !== undefined) {
            ...
            content =
                attrControl !== null ? (React.createElement(react_bootstrap_1.FormControl.Static, { componentClass: "div" }, React.createElement(ExtensionGate_1.default, { id: `extension-${rowIds[0]}-${attribute.id}` }, attrControl))) : null;
        }
        else {
            const values = rowIds
            ...
            if (attribute.edit.onChangeValue !== undefined) {
                ...
                content =
                    attribute.edit.choices !== undefined
        ...
        const helpIcon = attribute.help !== undefined ? (React.createElement(More_1.default, { id: `more-tableattribute-${attribute.id}`, name: (0, i18n_1.preT)(t, attribute.name, undefined, true) }, (0, i18n_1.preT)(t, attribute.help, undefined, true))) : null;
    ...
    renderSelect(values, readOnly) {
        ...
        if (readOnly) {
            ...
            const currentIcon = currentChoice !== undefined ? currentChoice.icon : undefined;
...
class DetailBox extends ComponentEx_1.ComponentEx {
    constructor(props) {
        ...
        this.onChangeData = (rowIds, attributeId, value) => {
            ...
            if (attribute.supportsMultiple === true) {
                attribute.edit.onChangeValue(rowIds
                    .map((rowId) => rawData[rowId])
                    .filter((iter) => iter !== undefined), value);
            }
    ...
    render() {
        ...
        const detailList = attributes
            ...
            (rowIds.length === 1 || obj.supportsMultiple))
            .sort(attributeSort);
        ...
        const visClass = show
            ? "table-form-details-show"
            : "table-form-details-hide";
