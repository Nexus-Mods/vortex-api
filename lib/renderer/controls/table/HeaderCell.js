    ...
    constructor() {
        ...
        this.cycleDirection = (evt) => {
            ...
            if (attribute.isSortable) {
                const direction = (_a = state === null || state === void 0 ? void 0 : state.sortDirection) !== null && _a !== void 0 ? _a : "none";
            ...
            React.createElement("div", { style: { display: "flex", flexDirection: "column" } },
                React.createElement("div", { className: "flex-fill", style: { display: "flex", flexDirection: "row" }, onClick: this.cycleDirection },
                    React.createElement("div", { style: { margin: 0, display: "flex", alignItems: "center" } },
                        ...
                        attribute.help !== undefined ? (React.createElement(More_1.default, { id: `more-${attribute.name}`, name: (0, i18n_1.preT)(t, attribute.name) }, (0, i18n_1.preT)(t, attribute.help))) : null),
