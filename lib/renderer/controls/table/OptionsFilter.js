...
function WrappedOptionsFilterComponent(boundProps) {
...
function OptionsFilterComponent(props) {
    ...
    const changeFilter = React.useCallback((newFilter) => {
        onSetFilter(attributeId, newFilter !== undefined && newFilter !== null
            ? newFilter.value
            : undefined);
    }, [attributeId, onSetFilter]);
...
class OptionsFilter {
    ...
    matches(filter, value) {
        ...
        if (Array.isArray(value)) {
            ...
            return this.mMulti ? filtUnsane.has(value) : filtUnsane === value;
        }
    }
    isEmpty(filter) {
