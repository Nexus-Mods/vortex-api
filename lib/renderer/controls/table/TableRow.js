...
class TableCell extends React.Component {
    ...
    render() {
        ...
        if (attribute.customRenderer !== undefined) {
            ...
            content =
                attrControl !== null ? (React.createElement(ExtensionGate_1.default, { id: `extension-${rowId}-${attribute.id}` }, attrControl)) : null;
        }
        else {
            content = this.renderDefault();
        }
        return attribute.isExtensible ? (React.createElement(ExtensibleControl_1.default, { group: `${tableId}-${attribute.id}`, wrapperProps: { rowId } }, content)) : (content);
    }
    renderDefault() {
        ...
        if (data === undefined || data === null) {
        ...
        else if (attribute.edit.onChangeValue !== undefined &&
            ...
            if (cellType === "string") {
                ...
                return (React.createElement("span", null, data !== undefined
    ...
    renderAction(data) {
        ...
        return (React.createElement(Dropdown_1.default, { id: `dropdown-${tableId}-${attribute.id}`, container: container, pullRight: right, onToggle: this.openChoice },
            React.createElement(TooltipControls_1.Button, { id: `btn-${tableId}-${attribute.id}`, className: `btn-${tableId}-${attribute.id}-${key} dropdown-title`, key: key, onClick: this.cycle, onSelect: this.changeCell, tooltip: (0, i18n_1.preT)(t, attribute.description, undefined, true) },
                currentChoice !== undefined && currentChoice.icon !== undefined ? (React.createElement(Icon_1.default, { name: currentChoice.icon })) : null,
            ...
            this.state.isOpen ? (React.createElement(Dropdown_1.default.Menu, { onSelect: this.changeCell }, choices
                .filter((choice) => choice.visible !== false)
                .map(this.renderChoice))) : (React.createElement(Dropdown_1.DummyMenu, null))));
    }
    renderSelect(data) {
