...
class ZoomableImage extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: className },
            url !== undefined ? (React.createElement(react_bootstrap_1.Image, { className: "zoomable-image", src: url, onClick: this.toggleOverlay })) : (React.createElement(Icon_1.default, { name: "placeholder-image" })),
