...
const BrTag_1 = __importDefault(require("./BrTag"));
const FontTag_1 = __importDefault(require("./FontTag"));
const HeadingTag_1 = __importDefault(require("./HeadingTag"));
const IdentityTag_1 = __importDefault(require("./IdentityTag"));
const LineTag_1 = __importDefault(require("./LineTag"));
const LinkTag_1 = __importDefault(require("./LinkTag"));
const MoreTag_1 = __importDefault(require("./MoreTag"));
const SizeTag_1 = __importDefault(require("./SizeTag"));
const SpoilerTag_1 = __importDefault(require("./SpoilerTag"));
const StyleTag_1 = __importDefault(require("./StyleTag"));
const SvgTag_1 = __importDefault(require("./SvgTag"));
const TooltipTag_1 = __importDefault(require("./TooltipTag"));
const YoutubeTag_1 = __importDefault(require("./YoutubeTag"));
