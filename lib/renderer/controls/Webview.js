        ...
        const overlapTest = setInterval(() => {
            if ((0, util_1.truthy)(bounds.current)) {
                ...
                if (wasVisible !== isVisible) {
                    (0, webview_1.positionBrowserView)(viewId.current, isVisible ? bounds.current : { x: 0, y: 0, width: 0, height: 0 });
...
class WebviewEmbed extends React.Component {
    constructor() {
        ...
        this.logMessage = (evt) => {
            if (evt.level > 2) {
                (0, log_1.log)("info", "from embedded page", {
                    level: evt.level,
                    message: evt.message,
                });
            }
    ...
    render() {
        return React.createElement("webview", Object.assign(Object.assign({}, (0, lodash_1.omit)(this.props, [
            "onLoading",
            "onNewWindow",
            "onFullscreen",
            "events",
