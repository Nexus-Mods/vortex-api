...
const TabLink = (_a) => {
    ...
    return (React.createElement("a", Object.assign({ ref: ref, className: (0, utils_1.joinClasses)(['tw:border-b tw:border-transparent tw:text-neutral-subdued focus-visible:tw:-outline-offset-2 tw:hover:text-neutral-moderate tw:transition-colors', className]), id: `tablist-${tabListId}-${tabId}`, role: "tab", tabIndex: -1, onKeyDown: onKeyDown }, props),
        React.createElement(exports.TabContent, { count: count, label: name })));
};
