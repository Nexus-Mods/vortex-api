...
exports.Link = (0, react_1.forwardRef)((_a, ref) => {
    var { children, href, isExternal } = _a, props = __rest(_a, ["children", "href", "isExternal"]);
    return (React.createElement("a", Object.assign({ ref: ref, href: href }, (isExternal ? { rel: 'noreferrer', target: '_blank' } : {}), props), children));
});
