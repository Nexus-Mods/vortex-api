...
const getButtonClasses = ({ buttonType, filled, isDisabled, isLoading, isResponsive, size, }) => {
    ...
    switch (buttonType) {
        case 'primary':
            classes.push('tw:bg-primary-moderate tw:text-neutral-inverted', canHover ? 'hover:tw:bg-primary-subdued' : '');
            break;
        case 'secondary':
        ...
        case 'tertiary':
            ...
            break;
        case 'success':
            classes.push('tw:bg-success-moderate tw:text-neutral-inverted', canHover ? 'hover:tw:bg-success-subdued' : '');
            break;
        case 'premium':
            classes.push('tw:bg-premium-moderate tw:text-neutral-strong', canHover ? 'hover:tw:bg-premium-subdued' : '');
            break;
    }
    return classes;
};
