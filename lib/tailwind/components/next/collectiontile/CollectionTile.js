...
const CollectionTile = ({ api, slug, gameId, title, author, coverImage, tags, stats, description, badges, onAddCollection, onViewPage, className, }) => {
    ...
    React.useEffect(() => {
        const collectionModInstalled = (0, selectors_1.isCollectionModPresent)(api.getState(), slug);
