...
const CollectionTile = ({ title, author, coverImage, tags, stats, description, onAddCollection, onViewPage, className, }) => {
    ...
    return (React.createElement("div", { className: `tw:w-[465px] tw:h-72 tw:bg-surface-mid tw:inline-flex tw:flex-col tw:justify-start tw:items-start ${className || ''}` },
            ...
            React.createElement("div", { className: "tw:self-stretch tw:flex-1 tw:inline-flex tw:justify-between tw:items-center" },
                ...
                React.createElement("div", { className: "tw:flex-1 tw:self-stretch tw:inline-flex tw:flex-col tw:justify-start tw:items-start" },
                    React.createElement("div", { className: "tw:self-stretch tw:pl-3 tw:pb-2 tw:flex tw:flex-col tw:justify-start tw:items-start tw:gap-1" },
                        React.createElement(Typography_1.Typography, { as: "div", className: "tw:self-stretch tw:justify-start tw:text-lg tw:font-semibold tw:font-['Inter'] tw:leading-relaxed", appearance: "strong" }, title),
                    ...
                    displayTags.length > 0 && (React.createElement("div", { className: "tw:self-stretch tw:pl-3 tw:flex tw:flex-col tw:justify-start tw:items-start tw:gap-2" },
                        React.createElement("div", { className: "tw:self-stretch tw:py-2 tw:border-t tw:border-b tw:border-stroke-neutral-translucent-weak tw:inline-flex tw:justify-start tw:items-center tw:gap-1.5 tw:flex-wrap tw:content-center" }, displayTags.map((tag, index) => (React.createElement(React.Fragment, { key: index },
                            React.createElement(Typography_1.Typography, { as: "div", typographyType: "body-xs", appearance: "none", className: `tw:justify-center tw:tracking-tight ${tag.toLowerCase() === 'adult' ? 'tw:text-danger-400' : 'tw:text-info-strong'}` }, tag),
                            index < displayTags.length - 1 && (React.createElement("div", { className: "tw:w-1 tw:h-0.5 tw:origin-top-left tw:rotate-45 tw:bg-neutral-subdued" })))))))),
                    React.createElement("div", { className: "tw:self-stretch tw:pl-3 tw:inline-flex tw:justify-start tw:items-center tw:gap-5" },
                        React.createElement("div", { className: "tw:flex-1 tw:py-2 tw:border-b tw:border-stroke-neutral-translucent-weak tw:flex tw:justify-start tw:items-center tw:gap-5" },
                            React.createElement("div", { className: "tw:flex tw:justify-start tw:items-center tw:gap-1 tw:overflow-hidden" },
                                ...
                                React.createElement(Typography_1.Typography, { as: "div", typographyType: "body-xs", appearance: "moderate", className: "tw:justify-start tw:tracking-tight" }, stats.downloads)),
                    ...
                    React.createElement("div", { className: "tw:self-stretch tw:flex-1 tw:pl-3 tw:py-1 tw:flex tw:flex-col tw:justify-start tw:items-start tw:gap-2" },
                        React.createElement(Typography_1.Typography, { as: "div", typographyType: "body-sm", appearance: "subdued", className: "tw:self-stretch tw:flex-1 tw:justify-start tw:leading-tight tw:line-clamp-3" }, description))))),
        React.createElement("div", { className: "tw:self-stretch tw:px-3 tw:py-2 tw:bg-surface-high tw:rounded-bl tw:rounded-br tw:inline-flex tw:justify-start tw:items-center tw:gap-2" },
            ...
            React.createElement(Button_1.Button, { buttonType: "tertiary", size: "sm", onClick: onViewPage }, "View page"))));
};
