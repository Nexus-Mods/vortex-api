...
const debouncer = new Debouncer_1.default((func) => {
    func === null || func === void 0 ? void 0 : func();
    return (0, util_1.delayed)(5000);
}, 5000, false, true);
const userInfoDebouncer = new Debouncer_1.default((func) => {
    func === null || func === void 0 ? void 0 : func();
    return Promise.resolve();
}, 10000, false, true);
const CollectionTile = ({ api, slug, title, author, coverImage, tags, stats, description, badges, onAddCollection, onViewPage, className, }) => {
    const [isHovered, setIsHovered] = React.useState(false);
    const [canBeAdded, setCanBeAdded] = React.useState(true);
    const [tooltip, setTooltip] = React.useState("Add this collection");
    ...
    const addCollectionDebounced = () => {
        debouncer.schedule(() => setPending(false), () => {
            onAddCollection === null || onAddCollection === void 0 ? void 0 : onAddCollection();
        });
    };
    React.useEffect(() => {
        var _a;
        ...
        const collectionModInstalled = (0, selectors_1.isCollectionModPresent)(state, slug);
        setCanBeAdded(!collectionModInstalled);
        setTooltip(collectionModInstalled || pending
    ...
    React.useEffect(() => {
        if (isHovered && (api === null || api === void 0 ? void 0 : api.events)) {
    ...
    const easyInstallBadge = badges === null || badges === void 0 ? void 0 : badges.find((badge) => badge.name.toLowerCase() === "easy install");
    return (React.createElement("div", { className: `tw:w-full tw:max-w-[465px] tw:h-[283px] tw:bg-surface-mid tw:flex tw:flex-col tw:justify-start tw:items-start ${className || ""}`, onMouseEnter: mouseEnter, onMouseLeave: mouseLeave },
        React.createElement("div", { className: "tw:self-stretch tw:flex-1 tw:px-3 tw:pt-3 tw:rounded-tl tw:rounded-tr tw:flex tw:flex-col tw:justify-start tw:items-start tw:gap-2 tw:overflow-hidden" },
            React.createElement("div", { className: "tw:self-stretch tw:flex tw:flex-1 tw:justify-between tw:items-start" },
                React.createElement("div", { className: "tw:w-[175px] tw:h-[219px] tw:relative tw:shrink-0" },
                    React.createElement("div", { className: "tw:absolute tw:top-0 tw:left-0" },
                        React.createElement("img", { className: "tw:w-[166px] tw:h-52 tw:rounded-sm tw:object-cover", src: coverImage, alt: title }),
                        easyInstallBadge && (React.createElement("div", { className: "tw:absolute tw:rounded-b-sm tw:inset-x-0 tw:bottom-0 tw:z-10" },
                            React.createElement(Typography_1.Typography, { as: "p", typographyType: "title-xs", appearance: "none", className: "tw:flex tw:items-center tw:gap-x-0.5 tw:px-1.5 tw:py-0.5 tw:bg-info-weak tw:text-info-50" },
                                React.createElement(icon_1.Icon, { path: "mdiStar", size: "xs" }),
                                React.createElement("span", { className: "tw:px-0.5 tw:leading-5", title: easyInstallBadge.description }, easyInstallBadge.name)))))),
                React.createElement("div", { className: "tw:flex-1 tw:self-stretch tw:flex tw:flex-col tw:justify-start tw:items-start" },
                    React.createElement("div", { className: "tw:self-stretch tw:pl-3 tw:pb-2 tw:flex tw:flex-col tw:justify-start tw:items-start tw:gap-0" },
                        React.createElement(Typography_1.Typography, { as: "div", className: "tw:line-clamp-1 tw:font-semibold tw:wrap-break-word", appearance: "strong", typographyType: "body-xl" }, title),
                        ...
                        React.createElement("div", { className: "tw:self-stretch tw:py-1.5 tw:border-t tw:border-b tw:border-stroke-neutral-translucent-weak tw:inline-flex tw:justify-start tw:items-center tw:gap-1.5 tw:flex-wrap tw:content-center" }, displayTags.map((tag, index) => {
                            ...
                            return (React.createElement(React.Fragment, { key: index },
                                React.createElement(Typography_1.Typography, { as: "div", typographyType: "body-xs", appearance: "none", className: `tw:justify-center tw:tracking-tight ${tagText.toLowerCase() === "adult"
                                        ...
                                        : "tw:text-neutral-moderate"}` }, tagText),
                    ...
                    React.createElement("div", { className: "tw:self-stretch tw:flex-1 tw:pl-3 tw:py-1 tw:flex tw:flex-col tw:justify-start tw:items-start tw:gap-2" },
                        React.createElement(Typography_1.Typography, { as: "div", typographyType: "body-md", appearance: "subdued", className: "tw:line-clamp-4 tw:wrap-break-word tw:leading-tight" }, description))))),
        React.createElement("div", { className: "tw:self-stretch tw:p-3 tw:bg-surface-high tw:rounded-bl tw:rounded-br tw:inline-flex tw:justify-start tw:items-center tw:gap-2" },
            React.createElement(Button_1.Button, { title: tooltip, disabled: !canBeAdded || pending, buttonType: "primary", size: "sm", onClick: addCollection }, "Add collection"),
