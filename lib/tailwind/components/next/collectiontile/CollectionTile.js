...
const CollectionTile = ({ title, author, coverImage, tags, stats, description, onAddCollection, onViewPage, className, }) => {
    ...
    return (React.createElement("div", { className: `tw:w-full tw:max-w-[465px] tw:h-[275px] tw:bg-surface-mid tw:flex tw:flex-col tw:justify-start tw:items-start ${className || ''}` },
            ...
            React.createElement("div", { className: "tw:self-stretch tw:flex tw:flex-1 tw:justify-between tw:items-start" },
                ...
                React.createElement("div", { className: "tw:flex-1 tw:self-stretch tw:flex tw:flex-col tw:justify-start tw:items-start" },
                    React.createElement("div", { className: "tw:self-stretch tw:pl-3 tw:pb-2 tw:flex tw:flex-col tw:justify-start tw:items-start tw:gap-1" },
                        React.createElement(Typography_1.Typography, { as: "div", className: "tw:line-clamp-2 tw:font-semibold tw:break-words", appearance: "strong", typographyType: "body-xl" }, title),
