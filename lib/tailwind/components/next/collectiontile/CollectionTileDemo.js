...
const CollectionTileDemo = () => {
    ...
    return (React.createElement("div", { className: "tw:p-6 tw:space-y-8" },
        ...
        React.createElement("div", { className: "tw:space-y-6" },
            ...
            React.createElement("div", { className: "tw:flex tw:flex-col tw:gap-6" }, mockCollections.map((collection) => (React.createElement(CollectionTile_1.CollectionTile, Object.assign({ key: collection.id }, collection, { onAddCollection: () => handleAddCollection(collection.title), onViewPage: () => handleViewPage(collection.title) })))))),
