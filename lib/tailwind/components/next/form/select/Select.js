...
const Select = (_a) => {
    ...
    return (React.createElement(formfield_1.FormField, { className: className, disabled: disabled, errorMessage: errorMessage, hideLabel: hideLabel, hints: hints, id: id, label: label, showRequiredLabel: showRequiredLabel !== null && showRequiredLabel !== void 0 ? showRequiredLabel : required },
        React.createElement("div", { className: (0, utils_1.joinClasses)(["tw:relative tw:flex tw:flex-col", className], {
                "tw:opacity-40": disabled,
            }) },
            React.createElement("select", Object.assign({}, props, { ref: ref, "aria-describedby": !!errorMessage
                    ? `${id}_error`
                    : hints.length > 0
                        ? `${id}_hints`
                        : undefined, "aria-invalid": !!errorMessage || undefined, className: (0, utils_1.joinClasses)([
