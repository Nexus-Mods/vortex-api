...
const FormField = ({ children, className, disabled, errorMessage, hideLabel = false, hints = [], hintsTypographyType = 'body-md', id, inputLength = 0, label = '', maxLength, ref, showRequiredLabel, }) => {
    ...
    return (React.createElement("div", { ref: ref, className: (0, utils_1.joinClasses)(['tw:w-full tw:min-w-0', className], { 'tw:opacity-40 tw:pointer-events-none': disabled }) },
        React.createElement("label", { className: (0, utils_1.joinClasses)(['tw:mb-2 tw:flex tw:gap-x-1 tw:text-sm'], { 'tw:sr-only': hideLabel }), htmlFor: id },
